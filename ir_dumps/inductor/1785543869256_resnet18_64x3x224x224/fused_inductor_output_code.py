# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/5d/c5d7w2h5agc34gpyhifcrfpzvcl4sg7h5g5nu464mnf4fy2zbjkg.py =====
# AOT ID: ['0_inference']
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/4t/c4tevxxq4xsck664wf6an4vhjt5rjx5zipd6ydzkoo6qmgihyrj7.py
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/5d/c5d7iryokf36uqdn4c27kdstl3vsuxsfmbdwzam3m4pdoda6tku3.py
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/be/cbeuesdv4vjdjoaio63q4wqe34zy5fe35cu5o5bti6bjaepatjot.py
...
#   out_2 => relu_1
# Graph fragment:
#   %convolution_1 : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0" = PlaceHolder[target=convolution_1]
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/hz/chznirc43bc7sqbck22qpt64z3b3mcit2he5dnqlzdlzv4bviuqy.py
...
#   out_6 => relu_2
# Graph fragment:
#   %convolution_2 : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0" = PlaceHolder[target=convolution_2]
...
#   %getitem : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0" = PlaceHolder[target=getitem]
...
#   %add_6 : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_5, %getitem), kwargs = {})
#   %relu_2 : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_6,), kwargs = {})
#   return %relu_2
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/dq/cdqzojjg5juab53sgqh2ua2fkrvbvezwjgnpqpqmcrexk65hdptf.py
...
#   out_16 => relu_5
# Graph fragment:
#   %convolution_5 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=convolution_5]
...
#   %sub_5 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_5, %unsqueeze_41), kwargs = {})
...
#   %mul_16 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_5, %unsqueeze_43), kwargs = {})
...
#   %mul_17 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_16, %unsqueeze_45), kwargs = {})
...
#   %add_13 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %unsqueeze_47), kwargs = {})
#   %relu_5 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_13,), kwargs = {})
#   return %relu_5
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/36/c365nv47idzsg6d7da4yswdymwccvwtbob7wc3pl3uorgbkd4vp2.py
...
#   out_20 => relu_6
# Graph fragment:
#   %convolution_6 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=convolution_6]
...
#   %convolution_7 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=convolution_7]
...
#   %add_18 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=add_18]
...
#   %sub_6 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_6, %unsqueeze_49), kwargs = {})
...
#   %mul_19 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_6, %unsqueeze_51), kwargs = {})
...
#   %mul_20 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_19, %unsqueeze_53), kwargs = {})
...
#   %add_15 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_20, %unsqueeze_55), kwargs = {})
...
#   %sub_7 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_7, %unsqueeze_57), kwargs = {})
...
#   %mul_22 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_7, %unsqueeze_59), kwargs = {})
...
#   %mul_23 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_22, %unsqueeze_61), kwargs = {})
...
#   %add_17 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_23, %unsqueeze_63), kwargs = {})
#   %add_18 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_15, %add_17), kwargs = {})
#   %relu_6 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_18,), kwargs = {})
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/7t/c7tw3rq6u7quvgv5wo3erucn5o72j4lhfno4znrossrxo4ndrbre.py
...
#   out_27 => relu_8
# Graph fragment:
#   %convolution_9 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=convolution_9]
...
#   %relu_6 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=relu_6]
...
#   %sub_9 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_9, %unsqueeze_73), kwargs = {})
...
#   %mul_28 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_9, %unsqueeze_75), kwargs = {})
...
#   %mul_29 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %unsqueeze_77), kwargs = {})
...
#   %add_22 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_29, %unsqueeze_79), kwargs = {})
#   %add_23 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_22, %relu_6), kwargs = {})
#   %relu_8 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_23,), kwargs = {})
#   return %relu_8
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/oa/coatcsl7dx5yioavcmrpk3pd6ltprlp2c4bcghe4owzyxxjcyvee.py
...
#   out_30 => relu_9
# Graph fragment:
#   %convolution_10 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=convolution_10]
...
#   %sub_10 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_10, %unsqueeze_81), kwargs = {})
...
#   %mul_31 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_10, %unsqueeze_83), kwargs = {})
...
#   %mul_32 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_31, %unsqueeze_85), kwargs = {})
...
#   %add_25 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_32, %unsqueeze_87), kwargs = {})
#   %relu_9 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_25,), kwargs = {})
#   return %relu_9
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/mw/cmwkejt3ddpreyalynizseainubnscdarcsihczppslkst7wbgch.py
...
#   out_34 => relu_10
# Graph fragment:
#   %convolution_11 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=convolution_11]
...
#   %convolution_12 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=convolution_12]
...
#   %add_30 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=add_30]
...
#   %sub_11 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_11, %unsqueeze_89), kwargs = {})
...
#   %mul_34 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_11, %unsqueeze_91), kwargs = {})
...
#   %mul_35 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_34, %unsqueeze_93), kwargs = {})
...
#   %add_27 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_35, %unsqueeze_95), kwargs = {})
...
#   %sub_12 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_12, %unsqueeze_97), kwargs = {})
...
#   %mul_37 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_12, %unsqueeze_99), kwargs = {})
...
#   %mul_38 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_37, %unsqueeze_101), kwargs = {})
...
#   %add_29 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_38, %unsqueeze_103), kwargs = {})
#   %add_30 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_27, %add_29), kwargs = {})
#   %relu_10 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_30,), kwargs = {})
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/tp/ctpuztjrjdyev2eociaa3vvgqdib6uqc4xfh54pxjdotxnoglfst.py
...
#   out_41 => relu_12
# Graph fragment:
#   %convolution_14 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=convolution_14]
...
#   %relu_10 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=relu_10]
...
#   %sub_14 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_14, %unsqueeze_113), kwargs = {})
...
#   %mul_43 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_14, %unsqueeze_115), kwargs = {})
...
#   %mul_44 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_43, %unsqueeze_117), kwargs = {})
...
#   %add_34 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_44, %unsqueeze_119), kwargs = {})
#   %add_35 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_34, %relu_10), kwargs = {})
#   %relu_12 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_35,), kwargs = {})
#   return %relu_12
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/ck/cckjylt3j5d6ezcbnmseig4vytnzvva5t6qbz37x6o5265fupanp.py
...
#   out_44 => relu_13
# Graph fragment:
#   %convolution_15 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=convolution_15]
...
#   %sub_15 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_15, %unsqueeze_121), kwargs = {})
...
#   %mul_46 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_15, %unsqueeze_123), kwargs = {})
...
#   %mul_47 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_46, %unsqueeze_125), kwargs = {})
...
#   %add_37 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_47, %unsqueeze_127), kwargs = {})
#   %relu_13 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_37,), kwargs = {})
#   return %relu_13
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/ch/cchb7wazwiqojmh5wql4uyjlsxwfhtxa7mmxx7rtu5ueofgs5sfx.py
...
#   out_48 => relu_14
# Graph fragment:
#   %convolution_16 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=convolution_16]
...
#   %convolution_17 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=convolution_17]
...
#   %add_42 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=add_42]
...
#   %sub_16 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_16, %unsqueeze_129), kwargs = {})
...
#   %mul_49 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_16, %unsqueeze_131), kwargs = {})
...
#   %mul_50 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_49, %unsqueeze_133), kwargs = {})
...
#   %add_39 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_50, %unsqueeze_135), kwargs = {})
...
#   %sub_17 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_17, %unsqueeze_137), kwargs = {})
...
#   %mul_52 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_17, %unsqueeze_139), kwargs = {})
...
#   %mul_53 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_52, %unsqueeze_141), kwargs = {})
...
#   %add_41 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_53, %unsqueeze_143), kwargs = {})
#   %add_42 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_39, %add_41), kwargs = {})
#   %relu_14 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_42,), kwargs = {})
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/qb/cqbazysuinc3rtixkbpktxtdcbm5h3vace5u45ukqhauqplscmfp.py
...
#   x_4 => mean
# Graph fragment:
#   %convolution_19 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=convolution_19]
...
#   %relu_14 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=relu_14]
#   %buf40 : Tensor "f32[64, 512, 1, 1][512, 1, 32768, 32768]cuda:0" = PlaceHolder[target=buf40]
...
#   %sub_19 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_19, %unsqueeze_153), kwargs = {})
...
#   %mul_58 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_19, %unsqueeze_155), kwargs = {})
...
#   %mul_59 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_58, %unsqueeze_157), kwargs = {})
...
#   %add_46 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_59, %unsqueeze_159), kwargs = {})
#   %add_47 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_46, %relu_14), kwargs = {})
#   %relu_16 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_47,), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__native_batch_norm_legit_no_training_add_mean_relu_12', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 6, 'num_reduction': 1, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 13115392, 'r0_': 0}}
)
@triton.jit
def triton_per_fused__native_batch_norm_legit_no_training_add_mean_relu_12(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 32768
    r0_numel = 49
    ...
    tmp16 = tl.load(in_ptr5 + (x0 + 512*r0_2 + 25088*x1), r0_mask, other=0.0)
    tmp2 = tmp0 - tmp1
    tmp4 = 1e-05
    tmp5 = tmp3 + tmp4
    tmp6 = libdevice.sqrt(tmp5)
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        assert_size_stride(buf3, (64, 64, 56, 56), (200704, 1, 3584, 64), 'torch.ops.aten.convolution.default')
        del arg6_1
        buf4 = buf3; del buf3  # reuse
        # Topologically Sorted Source Nodes: [out_1, out_2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_2.run(buf4, arg7_1, arg8_1, arg9_1, arg10_1, 12845056, stream=stream0)
        del arg10_1
        del arg7_1
        del arg8_1
        del arg9_1
        ...
        # Topologically Sorted Source Nodes: [out_4, out_5, out_6], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_3.run(buf6, arg12_1, arg13_1, arg14_1, arg15_1, buf2, 12845056, stream=stream0)
        del arg12_1
        del arg13_1
        del arg14_1
        del arg15_1
        ...
        assert_size_stride(buf7, (64, 64, 56, 56), (200704, 1, 3584, 64), 'torch.ops.aten.convolution.default')
        del arg16_1
        buf8 = buf7; del buf7  # reuse
        # Topologically Sorted Source Nodes: [out_8, out_9], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_2.run(buf8, arg17_1, arg18_1, arg19_1, arg20_1, 12845056, stream=stream0)
        del arg17_1
        del arg18_1
        del arg19_1
        del arg20_1
        ...
        assert_size_stride(buf9, (64, 64, 56, 56), (200704, 1, 3584, 64), 'torch.ops.aten.convolution.default')
        del arg21_1
        del buf8
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_3.run(buf10, arg22_1, arg23_1, arg24_1, arg25_1, buf6, 12845056, stream=stream0)
        del arg22_1
        del arg23_1
        del arg24_1
        del arg25_1
        ...
        assert_size_stride(buf11, (64, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg26_1
        buf12 = buf11; del buf11  # reuse
        # Topologically Sorted Source Nodes: [out_15, out_16], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_4.run(buf12, arg27_1, arg28_1, arg29_1, arg30_1, 6422528, stream=stream0)
        del arg27_1
        del arg28_1
        del arg29_1
        del arg30_1
        ...
        assert_size_stride(buf13, (64, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg31_1
        del buf12
        ...
        assert_size_stride(buf14, (64, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg36_1
        del buf10
        ...
        # Topologically Sorted Source Nodes: [out_18, input_2, out_19, out_20], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_5.run(buf16, arg32_1, arg33_1, arg34_1, arg35_1, buf14, arg37_1, arg38_1, arg39_1, arg40_1, 6422528, stream=stream0)
        del arg32_1
        del arg33_1
        del arg34_1
        del arg35_1
        ...
        assert_size_stride(buf17, (64, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg41_1
        buf18 = buf17; del buf17  # reuse
        # Topologically Sorted Source Nodes: [out_22, out_23], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_4.run(buf18, arg42_1, arg43_1, arg44_1, arg45_1, 6422528, stream=stream0)
        del arg42_1
        del arg43_1
        del arg44_1
        del arg45_1
        ...
        assert_size_stride(buf19, (64, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg46_1
        del buf18
        buf20 = buf19; del buf19  # reuse
        # Topologically Sorted Source Nodes: [out_25, out_26, out_27], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_6.run(buf20, arg47_1, arg48_1, arg49_1, arg50_1, buf16, 6422528, stream=stream0)
        del arg47_1
        del arg48_1
        del arg49_1
        del arg50_1
        ...
        assert_size_stride(buf21, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg51_1
        buf22 = buf21; del buf21  # reuse
        # Topologically Sorted Source Nodes: [out_29, out_30], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_7.run(buf22, arg52_1, arg53_1, arg54_1, arg55_1, 3211264, stream=stream0)
        del arg52_1
        del arg53_1
        del arg54_1
        del arg55_1
        ...
        assert_size_stride(buf23, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg56_1
        del buf22
        ...
        assert_size_stride(buf24, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg61_1
        del buf20
        ...
        # Topologically Sorted Source Nodes: [out_32, input_4, out_33, out_34], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_8.run(buf26, arg57_1, arg58_1, arg59_1, arg60_1, buf24, arg62_1, arg63_1, arg64_1, arg65_1, 3211264, stream=stream0)
        del arg57_1
        del arg58_1
        del arg59_1
        del arg60_1
        ...
        assert_size_stride(buf27, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg66_1
        buf28 = buf27; del buf27  # reuse
        # Topologically Sorted Source Nodes: [out_36, out_37], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_7.run(buf28, arg67_1, arg68_1, arg69_1, arg70_1, 3211264, stream=stream0)
        del arg67_1
        del arg68_1
        del arg69_1
        del arg70_1
        ...
        assert_size_stride(buf29, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg71_1
        del buf28
        buf30 = buf29; del buf29  # reuse
        # Topologically Sorted Source Nodes: [out_39, out_40, out_41], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_9.run(buf30, arg72_1, arg73_1, arg74_1, arg75_1, buf26, 3211264, stream=stream0)
        del arg72_1
        del arg73_1
        del arg74_1
        del arg75_1
        ...
        assert_size_stride(buf31, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg76_1
        buf32 = buf31; del buf31  # reuse
        # Topologically Sorted Source Nodes: [out_43, out_44], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_10.run(buf32, arg77_1, arg78_1, arg79_1, arg80_1, 1605632, stream=stream0)
        del arg77_1
        del arg78_1
        del arg79_1
        del arg80_1
        ...
        assert_size_stride(buf33, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg81_1
        del buf32
        ...
        assert_size_stride(buf34, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg86_1
        del buf30
        ...
        # Topologically Sorted Source Nodes: [out_46, input_6, out_47, out_48], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_11.run(buf36, arg82_1, arg83_1, arg84_1, arg85_1, buf34, arg87_1, arg88_1, arg89_1, arg90_1, 1605632, stream=stream0)
        del arg82_1
        del arg83_1
        del arg84_1
        del arg85_1
        ...
        assert_size_stride(buf37, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg91_1
        buf38 = buf37; del buf37  # reuse
        # Topologically Sorted Source Nodes: [out_50, out_51], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_relu_10.run(buf38, arg92_1, arg93_1, arg94_1, arg95_1, 1605632, stream=stream0)
        del arg92_1
        del arg93_1
        del arg94_1
        del arg95_1
        ...
        assert_size_stride(buf39, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg96_1
        del buf38
        buf40 = empty_strided_cuda((64, 512, 1, 1), (512, 1, 32768, 32768), torch.float32)
        buf41 = reinterpret_tensor(buf40, (64, 512, 1, 1), (512, 1, 1, 1), 0); del buf40  # reuse
        # Topologically Sorted Source Nodes: [out_53, out_54, out_55, x_4], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu, aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused__native_batch_norm_legit_no_training_add_mean_relu_12.run(buf41, buf39, arg97_1, arg98_1, arg99_1, arg100_1, buf36, 32768, 49, stream=stream0)
        del arg100_1
        del arg97_1
        del arg98_1
        del arg99_1
        del buf36
        del buf39
        buf42 = empty_strided_cuda((64, 1000), (1000, 1), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        extern_kernels.bias_addmm(reinterpret_tensor(arg102_1, (64, 1000), (0, 1), 0), reinterpret_tensor(buf41, (64, 512), (512, 1), 0), reinterpret_tensor(arg101_1, (512, 1000), (1, 512), 0), alpha=1, beta=1, out=buf42)
        del arg101_1
        del arg102_1
        del buf41
    return (buf42, )
...
class Runner:
    ...
    def call(self, args):
        ...
        (buf42,) = self.partitions[0](partition0_args)
        del partition0_args
        return (buf42, )
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/36/c365nv47idzsg6d7da4yswdymwccvwtbob7wc3pl3uorgbkd4vp2.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/4t/c4tevxxq4xsck664wf6an4vhjt5rjx5zipd6ydzkoo6qmgihyrj7.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/5d/c5d7iryokf36uqdn4c27kdstl3vsuxsfmbdwzam3m4pdoda6tku3.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/7t/c7tw3rq6u7quvgv5wo3erucn5o72j4lhfno4znrossrxo4ndrbre.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/be/cbeuesdv4vjdjoaio63q4wqe34zy5fe35cu5o5bti6bjaepatjot.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/ch/cchb7wazwiqojmh5wql4uyjlsxwfhtxa7mmxx7rtu5ueofgs5sfx.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/ck/cckjylt3j5d6ezcbnmseig4vytnzvva5t6qbz37x6o5265fupanp.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/dq/cdqzojjg5juab53sgqh2ua2fkrvbvezwjgnpqpqmcrexk65hdptf.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/hz/chznirc43bc7sqbck22qpt64z3b3mcit2he5dnqlzdlzv4bviuqy.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/mw/cmwkejt3ddpreyalynizseainubnscdarcsihczppslkst7wbgch.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/oa/coatcsl7dx5yioavcmrpk3pd6ltprlp2c4bcghe4owzyxxjcyvee.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/qb/cqbazysuinc3rtixkbpktxtdcbm5h3vace5u45ukqhauqplscmfp.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/36/c365nv47idzsg6d7da4yswdymwccvwtbob7wc3pl3uorgbkd4vp2.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/4t/c4tevxxq4xsck664wf6an4vhjt5rjx5zipd6ydzkoo6qmgihyrj7.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/5d/c5d7iryokf36uqdn4c27kdstl3vsuxsfmbdwzam3m4pdoda6tku3.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/7t/c7tw3rq6u7quvgv5wo3erucn5o72j4lhfno4znrossrxo4ndrbre.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/be/cbeuesdv4vjdjoaio63q4wqe34zy5fe35cu5o5bti6bjaepatjot.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/ch/cchb7wazwiqojmh5wql4uyjlsxwfhtxa7mmxx7rtu5ueofgs5sfx.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/ck/cckjylt3j5d6ezcbnmseig4vytnzvva5t6qbz37x6o5265fupanp.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/dq/cdqzojjg5juab53sgqh2ua2fkrvbvezwjgnpqpqmcrexk65hdptf.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/hz/chznirc43bc7sqbck22qpt64z3b3mcit2he5dnqlzdlzv4bviuqy.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/mw/cmwkejt3ddpreyalynizseainubnscdarcsihczppslkst7wbgch.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/oa/coatcsl7dx5yioavcmrpk3pd6ltprlp2c4bcghe4owzyxxjcyvee.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/qb/cqbazysuinc3rtixkbpktxtdcbm5h3vace5u45ukqhauqplscmfp.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tmpti306e1o/tp/ctpuztjrjdyev2eociaa3vvgqdib6uqc4xfh54pxjdotxnoglfst.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_04/base/attempt_01/torchinductor/tp/ctpuztjrjdyev2eociaa3vvgqdib6uqc4xfh54pxjdotxnoglfst.py =====
