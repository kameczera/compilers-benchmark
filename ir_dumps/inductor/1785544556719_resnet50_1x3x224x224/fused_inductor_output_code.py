# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/xu/cxuc3vyz65pyujreke24sw3df6k3hljemkvusbgwukfekyvcplfm.py =====
# AOT ID: ['0_inference']
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/63/c63uf75bycwyapy744rixr22kksqjxa3jttvcz22zoewgnu6t546.py
...
#   x_2 => relu
# Graph fragment:
#   %convolution : Tensor "f32[1, 64, 112, 112][802816, 1, 7168, 64]cuda:0" = PlaceHolder[target=convolution]
...
#   %sub : Tensor "f32[1, 64, 112, 112][802816, 1, 7168, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution, %unsqueeze_1), kwargs = {})
...
#   %mul_1 : Tensor "f32[1, 64, 112, 112][802816, 1, 7168, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %unsqueeze_3), kwargs = {})
...
#   %mul_2 : Tensor "f32[1, 64, 112, 112][802816, 1, 7168, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_1, %unsqueeze_5), kwargs = {})
...
#   %add_1 : Tensor "f32[1, 64, 112, 112][802816, 1, 7168, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_2, %unsqueeze_7), kwargs = {})
#   %relu : Tensor "f32[1, 64, 112, 112][802816, 1, 7168, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_1,), kwargs = {})
#   return %relu
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/yl/cylgvooxzn7bd6hiyxpwhtocfguxxmdg75lmrrqa2g5sv2don7ko.py
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/x5/cx5fgio4s3u54vncfdovx5oi752ktnwtkjent6kjdjslzcvlsatz.py
...
#   %convolution_1 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%getitem, %arg6_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_1 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_1, %unsqueeze_9), kwargs = {})
...
#   %mul_4 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_1, %unsqueeze_11), kwargs = {})
...
#   %mul_5 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_4, %unsqueeze_13), kwargs = {})
...
#   %add_3 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %unsqueeze_15), kwargs = {})
#   %relu_1 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_3,), kwargs = {})
#   return %relu_1
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_2', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 2409472}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/mh/cmhxumtlhd35qr5faect4ksj7zdva3ogi43zh4t3zmgt7gjvfeso.py
...
#   %add_10 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0" = PlaceHolder[target=add_10]
...
#   %sub_2 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_2, %unsqueeze_17), kwargs = {})
...
#   %mul_7 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_2, %unsqueeze_19), kwargs = {})
...
#   %mul_8 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_7, %unsqueeze_21), kwargs = {})
...
#   %add_5 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %unsqueeze_23), kwargs = {})
#   %relu_2 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_5,), kwargs = {})
#   %convolution_3 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_2, %arg16_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_3 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_3, %unsqueeze_25), kwargs = {})
...
#   %mul_10 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_3, %unsqueeze_27), kwargs = {})
...
#   %mul_11 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_10, %unsqueeze_29), kwargs = {})
...
#   %add_7 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %unsqueeze_31), kwargs = {})
#   %convolution_4 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%getitem, %arg21_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_4 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_4, %unsqueeze_33), kwargs = {})
...
#   %mul_13 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_4, %unsqueeze_35), kwargs = {})
...
#   %mul_14 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_13, %unsqueeze_37), kwargs = {})
...
#   %add_9 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_14, %unsqueeze_39), kwargs = {})
#   %add_10 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_7, %add_9), kwargs = {})
#   %relu_3 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_10,), kwargs = {})
#   %convolution_5 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_3, %arg26_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   return %add_10,%buf10
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/rt/crtnhy43pyhfruky6gdfxuengcleuhsj4dlp4y5fc7kwfsymvp25.py
...
#   out_9 => relu_3
# Graph fragment:
#   %buf15 : Tensor "f32[3136, 256][256, 1]cuda:0" = PlaceHolder[target=buf15]
...
#   %sub_6 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_6, %unsqueeze_49), kwargs = {})
...
#   %mul_19 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_6, %unsqueeze_51), kwargs = {})
...
#   %mul_20 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_19, %unsqueeze_53), kwargs = {})
...
#   %add_14 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_20, %unsqueeze_55), kwargs = {})
#   %relu_5 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_14,), kwargs = {})
#   %convolution_7 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_5, %arg36_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_7 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_7, %unsqueeze_57), kwargs = {})
...
#   %mul_22 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_7, %unsqueeze_59), kwargs = {})
...
#   %mul_23 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_22, %unsqueeze_61), kwargs = {})
...
#   %add_16 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_23, %unsqueeze_63), kwargs = {})
#   %add_17 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_16, %relu_3), kwargs = {})
#   %relu_6 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_17,), kwargs = {})
#   return %relu_6
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/xc/cxcxcsw4irwyxtg3kymgct336n67apcjzls2zbgjwdiqgr3mjfto.py
...
#   out_29 => relu_9
# Graph fragment:
#   %buf21 : Tensor "f32[3136, 256][256, 1]cuda:0" = PlaceHolder[target=buf21]
...
#   %sub_9 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_9, %unsqueeze_73), kwargs = {})
...
#   %mul_28 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_9, %unsqueeze_75), kwargs = {})
...
#   %mul_29 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %unsqueeze_77), kwargs = {})
...
#   %add_21 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_29, %unsqueeze_79), kwargs = {})
#   %relu_8 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_21,), kwargs = {})
#   %convolution_10 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_8, %arg51_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_10 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_10, %unsqueeze_81), kwargs = {})
...
#   %mul_31 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_10, %unsqueeze_83), kwargs = {})
...
#   %mul_32 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_31, %unsqueeze_85), kwargs = {})
...
#   %add_23 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_32, %unsqueeze_87), kwargs = {})
#   %add_24 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_23, %relu_6), kwargs = {})
#   %relu_9 : Tensor "f32[1, 256, 56, 56][802816, 1, 14336, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_24,), kwargs = {})
#   return %relu_9
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/py/cpy2plana6zbwxeitv4q52mzgjoikcdqkprztwoojqdjzkkyb4yh.py
...
#   out_32 => relu_10
# Graph fragment:
#   %buf23 : Tensor "f32[3136, 128][128, 1]cuda:0" = PlaceHolder[target=buf23]
...
#   %convolution_11 : Tensor "f32[1, 128, 56, 56][401408, 1, 7168, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_9, %arg56_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_11 : Tensor "f32[1, 128, 56, 56][401408, 1, 7168, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_11, %unsqueeze_89), kwargs = {})
...
#   %mul_34 : Tensor "f32[1, 128, 56, 56][401408, 1, 7168, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_11, %unsqueeze_91), kwargs = {})
...
#   %mul_35 : Tensor "f32[1, 128, 56, 56][401408, 1, 7168, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_34, %unsqueeze_93), kwargs = {})
...
#   %add_26 : Tensor "f32[1, 128, 56, 56][401408, 1, 7168, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_35, %unsqueeze_95), kwargs = {})
#   %relu_10 : Tensor "f32[1, 128, 56, 56][401408, 1, 7168, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_26,), kwargs = {})
#   return %relu_10
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/nw/cnwwtdx73n4i3wu7m37i6f7rwrkqcolm4q4zop7duosjv43lcjh5.py
...
# Graph fragment:
#   %convolution_12 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=convolution_12]
...
#   %sub_12 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_12, %unsqueeze_97), kwargs = {})
...
#   %mul_37 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_12, %unsqueeze_99), kwargs = {})
...
#   %mul_38 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_37, %unsqueeze_101), kwargs = {})
...
#   %add_28 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_38, %unsqueeze_103), kwargs = {})
#   %relu_11 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_28,), kwargs = {})
#   %convolution_13 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_11, %arg66_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   return %buf26
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 1206272}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/az/cazklvkh655efhlfk2sbylmpf2zi6762qxgfgpyfaplnedqzjsjc.py
...
# Graph fragment:
#   %buf27 : Tensor "f32[784, 512][512, 1]cuda:0" = PlaceHolder[target=buf27]
...
#   %convolution_14 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0" = PlaceHolder[target=convolution_14]
...
#   %add_33 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0" = PlaceHolder[target=add_33]
#   %unsqueeze_96 : Tensor "f32[128, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg62_1, -1), kwargs = {})
#   %unsqueeze_97 : Tensor "f32[128, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_96, -1), kwargs = {})
#   %sub_12 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_12, %unsqueeze_97), kwargs = {})
#   %add_27 : Tensor "f32[128][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg63_1, 1e-05), kwargs = {})
...
#   %sub_13 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_13, %unsqueeze_105), kwargs = {})
...
#   %mul_40 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_13, %unsqueeze_107), kwargs = {})
...
#   %mul_41 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_40, %unsqueeze_109), kwargs = {})
...
#   %add_30 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_41, %unsqueeze_111), kwargs = {})
...
#   %sub_14 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_14, %unsqueeze_113), kwargs = {})
...
#   %mul_43 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_14, %unsqueeze_115), kwargs = {})
...
#   %mul_44 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_43, %unsqueeze_117), kwargs = {})
...
#   %add_32 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_44, %unsqueeze_119), kwargs = {})
#   %add_33 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_30, %add_32), kwargs = {})
#   %relu_12 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_33,), kwargs = {})
#   %convolution_15 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_12, %arg76_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   return %add_33,%buf30
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/7j/c7jikac6g6hrp5pnrdjrodyvsabp3a5jvpxmsvnzootsy4khcd7d.py
...
#   out_49 => relu_15
# Graph fragment:
#   %buf35 : Tensor "f32[784, 512][512, 1]cuda:0" = PlaceHolder[target=buf35]
...
#   %sub_16 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_16, %unsqueeze_129), kwargs = {})
...
#   %mul_49 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_16, %unsqueeze_131), kwargs = {})
...
#   %mul_50 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_49, %unsqueeze_133), kwargs = {})
...
#   %add_37 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_50, %unsqueeze_135), kwargs = {})
#   %relu_14 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_37,), kwargs = {})
#   %convolution_17 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_14, %arg86_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_17 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_17, %unsqueeze_137), kwargs = {})
...
#   %mul_52 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_17, %unsqueeze_139), kwargs = {})
...
#   %mul_53 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_52, %unsqueeze_141), kwargs = {})
...
#   %add_39 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_53, %unsqueeze_143), kwargs = {})
#   %add_40 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_39, %relu_12), kwargs = {})
#   %relu_15 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_40,), kwargs = {})
#   return %relu_15
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'in_ptr4': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_9', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 6430720}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/cj/ccj5pocxkfx6yg5ph6m4yx3r3gxjrrkhgqah2zsgam2zeznqsv3n.py
...
#   out_59 => relu_18
# Graph fragment:
#   %buf41 : Tensor "f32[784, 512][512, 1]cuda:0" = PlaceHolder[target=buf41]
...
#   %relu_15 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0" = PlaceHolder[target=relu_15]
...
#   %sub_19 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_19, %unsqueeze_153), kwargs = {})
...
#   %mul_58 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_19, %unsqueeze_155), kwargs = {})
...
#   %mul_59 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_58, %unsqueeze_157), kwargs = {})
...
#   %add_44 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_59, %unsqueeze_159), kwargs = {})
#   %relu_17 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_44,), kwargs = {})
#   %convolution_20 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_17, %arg101_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_20 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_20, %unsqueeze_161), kwargs = {})
...
#   %mul_61 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_20, %unsqueeze_163), kwargs = {})
...
#   %mul_62 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_61, %unsqueeze_165), kwargs = {})
...
#   %add_46 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_62, %unsqueeze_167), kwargs = {})
#   %add_47 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_46, %relu_15), kwargs = {})
#   %relu_18 : Tensor "f32[1, 512, 28, 28][401408, 1, 14336, 512]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_47,), kwargs = {})
#   return %relu_18
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/fm/cfmdp4dkimcgvyl2ftqkwtlrrwema5ck2f4fvrpqtfkvnga2oick.py
...
#   out_72 => relu_22
# Graph fragment:
#   %buf49 : Tensor "f32[784, 256][256, 1]cuda:0" = PlaceHolder[target=buf49]
...
#   %convolution_24 : Tensor "f32[1, 256, 28, 28][200704, 1, 7168, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_21, %arg121_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_24 : Tensor "f32[1, 256, 28, 28][200704, 1, 7168, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_24, %unsqueeze_193), kwargs = {})
...
#   %mul_73 : Tensor "f32[1, 256, 28, 28][200704, 1, 7168, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_24, %unsqueeze_195), kwargs = {})
...
#   %mul_74 : Tensor "f32[1, 256, 28, 28][200704, 1, 7168, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_73, %unsqueeze_197), kwargs = {})
...
#   %add_56 : Tensor "f32[1, 256, 28, 28][200704, 1, 7168, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_74, %unsqueeze_199), kwargs = {})
#   %relu_22 : Tensor "f32[1, 256, 28, 28][200704, 1, 7168, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_56,), kwargs = {})
#   return %relu_22
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_11', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 2412544}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/uo/cuo4mnlvj757tkdbwzhgwqmwfal5abv7ydlgwqh6u5tboro2yydh.py
...
# Graph fragment:
#   %convolution_25 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=convolution_25]
...
#   %sub_25 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_25, %unsqueeze_201), kwargs = {})
...
#   %mul_76 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_25, %unsqueeze_203), kwargs = {})
...
#   %mul_77 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_76, %unsqueeze_205), kwargs = {})
...
#   %add_58 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_77, %unsqueeze_207), kwargs = {})
#   %relu_23 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_58,), kwargs = {})
#   %convolution_26 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_23, %arg131_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   return %buf52
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/ja/cja5rvgpfsdthjtpugt2uydu3vfjquvpa64mjgznkj3qubxatujs.py
...
# Graph fragment:
#   %buf53 : Tensor "f32[196, 1024][1024, 1]cuda:0" = PlaceHolder[target=buf53]
...
#   %convolution_27 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0" = PlaceHolder[target=convolution_27]
...
#   %add_63 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0" = PlaceHolder[target=add_63]
#   %unsqueeze_200 : Tensor "f32[256, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg127_1, -1), kwargs = {})
#   %unsqueeze_201 : Tensor "f32[256, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_200, -1), kwargs = {})
#   %sub_25 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_25, %unsqueeze_201), kwargs = {})
#   %add_57 : Tensor "f32[256][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg128_1, 1e-05), kwargs = {})
...
#   %sub_26 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_26, %unsqueeze_209), kwargs = {})
...
#   %mul_79 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_26, %unsqueeze_211), kwargs = {})
...
#   %mul_80 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_79, %unsqueeze_213), kwargs = {})
...
#   %add_60 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_80, %unsqueeze_215), kwargs = {})
...
#   %sub_27 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_27, %unsqueeze_217), kwargs = {})
...
#   %mul_82 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_27, %unsqueeze_219), kwargs = {})
...
#   %mul_83 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_82, %unsqueeze_221), kwargs = {})
...
#   %add_62 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_83, %unsqueeze_223), kwargs = {})
#   %add_63 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_60, %add_62), kwargs = {})
#   %relu_24 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_63,), kwargs = {})
#   %convolution_28 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_24, %arg141_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   return %add_63,%buf56
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'in_ptr4': '*fp32', 'in_ptr5': '*fp32', 'in_ptr6': '*fp32', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_13', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 10, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 4849664}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/gp/cgp5qre2twqosszphtxed4cavdiveyqkebwsqobhd43pxdnn7nzm.py
...
#   out_89 => relu_27
# Graph fragment:
#   %buf61 : Tensor "f32[196, 1024][1024, 1]cuda:0" = PlaceHolder[target=buf61]
...
#   %sub_29 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_29, %unsqueeze_233), kwargs = {})
...
#   %mul_88 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_29, %unsqueeze_235), kwargs = {})
...
#   %mul_89 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_88, %unsqueeze_237), kwargs = {})
...
#   %add_67 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_89, %unsqueeze_239), kwargs = {})
#   %relu_26 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_67,), kwargs = {})
#   %convolution_30 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_26, %arg151_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_30 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_30, %unsqueeze_241), kwargs = {})
...
#   %mul_91 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_30, %unsqueeze_243), kwargs = {})
...
#   %mul_92 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_91, %unsqueeze_245), kwargs = {})
...
#   %add_69 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_92, %unsqueeze_247), kwargs = {})
#   %add_70 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_69, %relu_24), kwargs = {})
#   %relu_27 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_70,), kwargs = {})
#   return %relu_27
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/xk/cxk2snbyqmsfoz3inyhfuduztwghgfp6t6nzwsiy62fra5ysawdm.py
...
#   out_99 => relu_30
# Graph fragment:
#   %buf67 : Tensor "f32[196, 1024][1024, 1]cuda:0" = PlaceHolder[target=buf67]
...
#   %relu_27 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0" = PlaceHolder[target=relu_27]
...
#   %sub_32 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_32, %unsqueeze_257), kwargs = {})
...
#   %mul_97 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_32, %unsqueeze_259), kwargs = {})
...
#   %mul_98 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_97, %unsqueeze_261), kwargs = {})
...
#   %add_74 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_98, %unsqueeze_263), kwargs = {})
#   %relu_29 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_74,), kwargs = {})
#   %convolution_33 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_29, %arg166_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_33 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_33, %unsqueeze_265), kwargs = {})
...
#   %mul_100 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_33, %unsqueeze_267), kwargs = {})
...
#   %mul_101 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_100, %unsqueeze_269), kwargs = {})
...
#   %add_76 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_101, %unsqueeze_271), kwargs = {})
#   %add_77 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_76, %relu_27), kwargs = {})
#   %relu_30 : Tensor "f32[1, 1024, 14, 14][200704, 1, 14336, 1024]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_77,), kwargs = {})
#   return %relu_30
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/ae/caewbhvw2a3jhyvhv5k45l266w3d7yg5z47vkp2b6r7ur4vvc5zm.py
...
#   out_132 => relu_40
# Graph fragment:
#   %buf87 : Tensor "f32[196, 512][512, 1]cuda:0" = PlaceHolder[target=buf87]
...
#   %convolution_43 : Tensor "f32[1, 512, 14, 14][100352, 1, 7168, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_39, %arg216_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_43 : Tensor "f32[1, 512, 14, 14][100352, 1, 7168, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_43, %unsqueeze_345), kwargs = {})
...
#   %mul_130 : Tensor "f32[1, 512, 14, 14][100352, 1, 7168, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_43, %unsqueeze_347), kwargs = {})
...
#   %mul_131 : Tensor "f32[1, 512, 14, 14][100352, 1, 7168, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_130, %unsqueeze_349), kwargs = {})
...
#   %add_100 : Tensor "f32[1, 512, 14, 14][100352, 1, 7168, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_131, %unsqueeze_351), kwargs = {})
#   %relu_40 : Tensor "f32[1, 512, 14, 14][100352, 1, 7168, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_100,), kwargs = {})
#   return %relu_40
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/ju/cju5ev5srzymwkyowdv5hyhghus4rfdzygjhol6fkfp6qb5n655l.py
...
# Graph fragment:
#   %convolution_44 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=convolution_44]
...
#   %sub_44 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_44, %unsqueeze_353), kwargs = {})
...
#   %mul_133 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_44, %unsqueeze_355), kwargs = {})
...
#   %mul_134 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_133, %unsqueeze_357), kwargs = {})
...
#   %add_102 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_134, %unsqueeze_359), kwargs = {})
#   %relu_41 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_102,), kwargs = {})
#   %convolution_45 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_41, %arg226_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   return %buf90
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_17', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 309248}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/gi/cgil6hqp4q4lyvix7sb23kp4gche54bmj5hn53zqxhuu2vmz73ch.py
...
# Graph fragment:
#   %buf91 : Tensor "f32[49, 2048][2048, 1]cuda:0" = PlaceHolder[target=buf91]
...
#   %convolution_46 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0" = PlaceHolder[target=convolution_46]
...
#   %add_107 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0" = PlaceHolder[target=add_107]
#   %unsqueeze_352 : Tensor "f32[512, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg222_1, -1), kwargs = {})
#   %unsqueeze_353 : Tensor "f32[512, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_352, -1), kwargs = {})
#   %sub_44 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_44, %unsqueeze_353), kwargs = {})
#   %add_101 : Tensor "f32[512][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg223_1, 1e-05), kwargs = {})
...
#   %sub_45 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_45, %unsqueeze_361), kwargs = {})
...
#   %mul_136 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_45, %unsqueeze_363), kwargs = {})
...
#   %mul_137 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_136, %unsqueeze_365), kwargs = {})
...
#   %add_104 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_137, %unsqueeze_367), kwargs = {})
...
#   %sub_46 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_46, %unsqueeze_369), kwargs = {})
...
#   %mul_139 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_46, %unsqueeze_371), kwargs = {})
...
#   %mul_140 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_139, %unsqueeze_373), kwargs = {})
...
#   %add_106 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_140, %unsqueeze_375), kwargs = {})
#   %add_107 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_104, %add_106), kwargs = {})
#   %relu_42 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_107,), kwargs = {})
#   %convolution_47 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_42, %arg236_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/3g/c3gduqijow5svvjjcbruqwld7urp733dflimffdhcdld6d4bgttn.py
...
#   out_149 => relu_45
# Graph fragment:
#   %buf99 : Tensor "f32[49, 2048][2048, 1]cuda:0" = PlaceHolder[target=buf99]
...
#   %sub_48 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_48, %unsqueeze_385), kwargs = {})
...
#   %mul_145 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_48, %unsqueeze_387), kwargs = {})
...
#   %mul_146 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_145, %unsqueeze_389), kwargs = {})
...
#   %add_111 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_146, %unsqueeze_391), kwargs = {})
#   %relu_44 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_111,), kwargs = {})
#   %convolution_49 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_44, %arg246_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_49 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_49, %unsqueeze_393), kwargs = {})
...
#   %mul_148 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_49, %unsqueeze_395), kwargs = {})
...
#   %mul_149 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_148, %unsqueeze_397), kwargs = {})
...
#   %add_113 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_149, %unsqueeze_399), kwargs = {})
#   %add_114 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_113, %relu_42), kwargs = {})
#   %relu_45 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_114,), kwargs = {})
#   return %relu_45
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'in_ptr4': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_19', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 1638400}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/6o/c6o7laozjye2qvhkwllawkylwdc2hoi4et7oenyluibrrvi2zgmn.py
...
#   x_4 => mean
# Graph fragment:
#   %buf105 : Tensor "f32[49, 2048][2048, 1]cuda:0" = PlaceHolder[target=buf105]
...
#   %sub_51 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_51, %unsqueeze_409), kwargs = {})
...
#   %mul_154 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_51, %unsqueeze_411), kwargs = {})
...
#   %mul_155 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_154, %unsqueeze_413), kwargs = {})
...
#   %add_118 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_155, %unsqueeze_415), kwargs = {})
#   %relu_47 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_118,), kwargs = {})
#   %convolution_52 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_47, %arg261_1, None, [1, 1], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_52 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convolution_52, %unsqueeze_417), kwargs = {})
...
#   %mul_157 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_52, %unsqueeze_419), kwargs = {})
...
#   %mul_158 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_157, %unsqueeze_421), kwargs = {})
...
#   %add_120 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_158, %unsqueeze_423), kwargs = {})
#   %add_121 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_120, %relu_45), kwargs = {})
#   %relu_48 : Tensor "f32[1, 2048, 7, 7][100352, 1, 14336, 2048]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_121,), kwargs = {})
...
def triton_per_fused__native_batch_norm_legit_no_training_add_convolution_mean_relu_20(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp16 = tl.load(in_ptr5 + (x0 + 2048*r0_1), r0_mask & xmask, other=0.0)
    tmp2 = tmp0 - tmp1
    tmp4 = 1e-05
    tmp5 = tmp3 + tmp4
    tmp6 = libdevice.sqrt(tmp5)
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__native_batch_norm_legit_no_training_relu_0.run(buf1, arg2_1, arg3_1, arg4_1, arg5_1, 802816, stream=stream0)
        del arg2_1
        del arg3_1
        del arg4_1
        del arg5_1
        ...
        # Topologically Sorted Source Nodes: [x_1, x_2, x_3], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_max_pool2d_with_indices_relu_1.run(buf1, buf2, 200704, stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [out, out_1, out_2], Original ATen: [aten.convolution, aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_2.run(buf4, arg7_1, arg8_1, arg9_1, arg10_1, 200704, stream=stream0)
        del arg10_1
        del arg7_1
        del arg8_1
        del arg9_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_2.run(buf6, arg12_1, arg13_1, arg14_1, arg15_1, 200704, stream=stream0)
        del arg12_1
        del arg13_1
        del arg14_1
        del arg15_1
        ...
        # Topologically Sorted Source Nodes: [out_4, out_5, out_6, out_7, input_1, input_2, out_8, out_9, out_10], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_3.run(buf9, arg17_1, arg18_1, arg19_1, arg20_1, buf8, arg22_1, arg23_1, arg24_1, arg25_1, buf10, 802816, stream=stream0)
        del arg17_1
        del arg18_1
        del arg19_1
        del arg20_1
        ...
        del arg25_1
        del buf8
        buf11 = empty_strided_cuda((3136, 64), (64, 1), torch.float32)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_2.run(buf12, arg27_1, arg28_1, arg29_1, arg30_1, 200704, stream=stream0)
        del arg27_1
        del arg28_1
        del arg29_1
        del arg30_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_2.run(buf14, arg32_1, arg33_1, arg34_1, arg35_1, 200704, stream=stream0)
        del arg32_1
        del arg33_1
        del arg34_1
        del arg35_1
        ...
        # Topologically Sorted Source Nodes: [out_9, out_14, out_15, out_16, out_17, out_18, out_19], Original ATen: [aten.relu, aten._native_batch_norm_legit_no_training, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_4.run(buf16, arg37_1, arg38_1, arg39_1, arg40_1, buf9, 802816, stream=stream0)
        del arg37_1
        del arg38_1
        del arg39_1
        del arg40_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_2.run(buf18, arg42_1, arg43_1, arg44_1, arg45_1, 200704, stream=stream0)
        del arg42_1
        del arg43_1
        del arg44_1
        del arg45_1
        ...
        assert_size_stride(buf19, (1, 64, 56, 56), (200704, 1, 3584, 64), 'torch.ops.aten.convolution.default')
        del arg46_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_2.run(buf20, arg47_1, arg48_1, arg49_1, arg50_1, 200704, stream=stream0)
        del arg47_1
        del arg48_1
        del arg49_1
        del arg50_1
        ...
        del arg51_1
        buf22 = reinterpret_tensor(buf21, (1, 256, 56, 56), (802816, 1, 14336, 256), 0); del buf21  # reuse
        # Topologically Sorted Source Nodes: [out_24, out_25, out_26, out_27, out_28, out_29], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_5.run(buf22, arg52_1, arg53_1, arg54_1, arg55_1, buf16, 802816, stream=stream0)
        del arg52_1
        del arg53_1
        del arg54_1
        del arg55_1
        ...
        # Topologically Sorted Source Nodes: [out_30, out_31, out_32], Original ATen: [aten.convolution, aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_6.run(buf24, arg57_1, arg58_1, arg59_1, arg60_1, 401408, stream=stream0)
        del arg57_1
        del arg58_1
        del arg59_1
        del arg60_1
        ...
        # Topologically Sorted Source Nodes: [out_34, out_35, out_36], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7.run(buf26, arg62_1, arg63_1, arg64_1, arg65_1, 100352, stream=stream0)
        del arg62_1
        del arg63_1
        del arg64_1
        del arg65_1
        ...
        assert_size_stride(buf28, (1, 512, 28, 28), (401408, 1, 14336, 512), 'torch.ops.aten.convolution.default')
        del arg71_1
        del buf22
        ...
        # Topologically Sorted Source Nodes: [out_34, out_35, out_36, out_37, input_4, out_38, out_39, out_40], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_8.run(buf29, arg67_1, arg68_1, arg69_1, arg70_1, buf28, arg72_1, arg73_1, arg74_1, arg75_1, buf30, 401408, stream=stream0)
        del arg67_1
        del arg68_1
        del arg69_1
        del arg70_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7.run(buf32, arg77_1, arg78_1, arg79_1, arg80_1, 100352, stream=stream0)
        del arg77_1
        del arg78_1
        del arg79_1
        del arg80_1
        ...
        assert_size_stride(buf33, (1, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg81_1
        del buf32
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7.run(buf34, arg82_1, arg83_1, arg84_1, arg85_1, 100352, stream=stream0)
        del arg82_1
        del arg83_1
        del arg84_1
        del arg85_1
        ...
        del arg86_1
        buf36 = reinterpret_tensor(buf35, (1, 512, 28, 28), (401408, 1, 14336, 512), 0); del buf35  # reuse
        # Topologically Sorted Source Nodes: [out_39, out_44, out_45, out_46, out_47, out_48, out_49], Original ATen: [aten.relu, aten._native_batch_norm_legit_no_training, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_9.run(buf36, arg87_1, arg88_1, arg89_1, arg90_1, buf29, 401408, stream=stream0)
        del arg87_1
        del arg88_1
        del arg89_1
        del arg90_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7.run(buf38, arg92_1, arg93_1, arg94_1, arg95_1, 100352, stream=stream0)
        del arg92_1
        del arg93_1
        del arg94_1
        del arg95_1
        ...
        assert_size_stride(buf39, (1, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg96_1
        del buf38
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7.run(buf40, arg97_1, arg98_1, arg99_1, arg100_1, 100352, stream=stream0)
        del arg100_1
        del arg97_1
        del arg98_1
        del arg99_1
        buf41 = reinterpret_tensor(buf29, (784, 512), (512, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [out_54, out_55, out_56], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        extern_kernels.mm(reinterpret_tensor(buf40, (784, 128), (128, 1), 0), reinterpret_tensor(arg101_1, (128, 512), (1, 128), 0), out=buf41)
        del arg101_1
        buf42 = reinterpret_tensor(buf41, (1, 512, 28, 28), (401408, 1, 14336, 512), 0); del buf41  # reuse
        # Topologically Sorted Source Nodes: [out_54, out_55, out_56, out_57, out_58, out_59], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_10.run(buf42, arg102_1, arg103_1, arg104_1, arg105_1, buf36, 401408, stream=stream0)
        del arg102_1
        del arg103_1
        del arg104_1
        del arg105_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7.run(buf44, arg107_1, arg108_1, arg109_1, arg110_1, 100352, stream=stream0)
        del arg107_1
        del arg108_1
        del arg109_1
        del arg110_1
        ...
        assert_size_stride(buf45, (1, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg111_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_7.run(buf46, arg112_1, arg113_1, arg114_1, arg115_1, 100352, stream=stream0)
        del arg112_1
        del arg113_1
        del arg114_1
        del arg115_1
        buf47 = reinterpret_tensor(buf36, (784, 512), (512, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [out_64, out_65, out_66], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        extern_kernels.mm(reinterpret_tensor(buf46, (784, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 512), (1, 128), 0), out=buf47)
        del arg116_1
        buf48 = reinterpret_tensor(buf47, (1, 512, 28, 28), (401408, 1, 14336, 512), 0); del buf47  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_10.run(buf48, arg117_1, arg118_1, arg119_1, arg120_1, buf42, 401408, stream=stream0)
        del arg117_1
        del arg118_1
        del arg119_1
        del arg120_1
        ...
        # Topologically Sorted Source Nodes: [out_70, out_71, out_72], Original ATen: [aten.convolution, aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_11.run(buf50, arg122_1, arg123_1, arg124_1, arg125_1, 200704, stream=stream0)
        del arg122_1
        del arg123_1
        del arg124_1
        del arg125_1
        ...
        # Topologically Sorted Source Nodes: [out_74, out_75, out_76], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf52, arg127_1, arg128_1, arg129_1, arg130_1, 50176, stream=stream0)
        del arg127_1
        del arg128_1
        del arg129_1
        del arg130_1
        ...
        assert_size_stride(buf54, (1, 1024, 14, 14), (200704, 1, 14336, 1024), 'torch.ops.aten.convolution.default')
        del arg136_1
        del buf48
        ...
        # Topologically Sorted Source Nodes: [out_74, out_75, out_76, out_77, input_6, out_78, out_79, out_80], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_13.run(buf55, arg132_1, arg133_1, arg134_1, arg135_1, buf54, arg137_1, arg138_1, arg139_1, arg140_1, buf56, 200704, stream=stream0)
        del arg132_1
        del arg133_1
        del arg134_1
        del arg135_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf58, arg142_1, arg143_1, arg144_1, arg145_1, 50176, stream=stream0)
        del arg142_1
        del arg143_1
        del arg144_1
        del arg145_1
        ...
        assert_size_stride(buf59, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg146_1
        del buf58
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf60, arg147_1, arg148_1, arg149_1, arg150_1, 50176, stream=stream0)
        del arg147_1
        del arg148_1
        del arg149_1
        del arg150_1
        ...
        del arg151_1
        buf62 = reinterpret_tensor(buf61, (1, 1024, 14, 14), (200704, 1, 14336, 1024), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [out_79, out_84, out_85, out_86, out_87, out_88, out_89], Original ATen: [aten.relu, aten._native_batch_norm_legit_no_training, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_14.run(buf62, arg152_1, arg153_1, arg154_1, arg155_1, buf55, 200704, stream=stream0)
        del arg152_1
        del arg153_1
        del arg154_1
        del arg155_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf64, arg157_1, arg158_1, arg159_1, arg160_1, 50176, stream=stream0)
        del arg157_1
        del arg158_1
        del arg159_1
        del arg160_1
        ...
        assert_size_stride(buf65, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg161_1
        del buf64
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf66, arg162_1, arg163_1, arg164_1, arg165_1, 50176, stream=stream0)
        del arg162_1
        del arg163_1
        del arg164_1
        del arg165_1
        buf67 = reinterpret_tensor(buf55, (196, 1024), (1024, 1), 0); del buf55  # reuse
        # Topologically Sorted Source Nodes: [out_94, out_95, out_96], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        extern_kernels.mm(reinterpret_tensor(buf66, (196, 256), (256, 1), 0), reinterpret_tensor(arg166_1, (256, 1024), (1, 256), 0), out=buf67)
        del arg166_1
        buf68 = reinterpret_tensor(buf67, (1, 1024, 14, 14), (200704, 1, 14336, 1024), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [out_94, out_95, out_96, out_97, out_98, out_99], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_15.run(buf68, arg167_1, arg168_1, arg169_1, arg170_1, buf62, 200704, stream=stream0)
        del arg167_1
        del arg168_1
        del arg169_1
        del arg170_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf70, arg172_1, arg173_1, arg174_1, arg175_1, 50176, stream=stream0)
        del arg172_1
        del arg173_1
        del arg174_1
        del arg175_1
        ...
        assert_size_stride(buf71, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg176_1
        del buf70
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf72, arg177_1, arg178_1, arg179_1, arg180_1, 50176, stream=stream0)
        del arg177_1
        del arg178_1
        del arg179_1
        del arg180_1
        buf73 = reinterpret_tensor(buf62, (196, 1024), (1024, 1), 0); del buf62  # reuse
        # Topologically Sorted Source Nodes: [out_104, out_105, out_106], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        extern_kernels.mm(reinterpret_tensor(buf72, (196, 256), (256, 1), 0), reinterpret_tensor(arg181_1, (256, 1024), (1, 256), 0), out=buf73)
        del arg181_1
        buf74 = reinterpret_tensor(buf73, (1, 1024, 14, 14), (200704, 1, 14336, 1024), 0); del buf73  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_15.run(buf74, arg182_1, arg183_1, arg184_1, arg185_1, buf68, 200704, stream=stream0)
        del arg182_1
        del arg183_1
        del arg184_1
        del arg185_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf76, arg187_1, arg188_1, arg189_1, arg190_1, 50176, stream=stream0)
        del arg187_1
        del arg188_1
        del arg189_1
        del arg190_1
        ...
        assert_size_stride(buf77, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg191_1
        del buf76
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf78, arg192_1, arg193_1, arg194_1, arg195_1, 50176, stream=stream0)
        del arg192_1
        del arg193_1
        del arg194_1
        del arg195_1
        buf79 = reinterpret_tensor(buf68, (196, 1024), (1024, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [out_114, out_115, out_116], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        extern_kernels.mm(reinterpret_tensor(buf78, (196, 256), (256, 1), 0), reinterpret_tensor(arg196_1, (256, 1024), (1, 256), 0), out=buf79)
        del arg196_1
        buf80 = reinterpret_tensor(buf79, (1, 1024, 14, 14), (200704, 1, 14336, 1024), 0); del buf79  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_15.run(buf80, arg197_1, arg198_1, arg199_1, arg200_1, buf74, 200704, stream=stream0)
        del arg197_1
        del arg198_1
        del arg199_1
        del arg200_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf82, arg202_1, arg203_1, arg204_1, arg205_1, 50176, stream=stream0)
        del arg202_1
        del arg203_1
        del arg204_1
        del arg205_1
        ...
        assert_size_stride(buf83, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg206_1
        del buf82
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_12.run(buf84, arg207_1, arg208_1, arg209_1, arg210_1, 50176, stream=stream0)
        del arg207_1
        del arg208_1
        del arg209_1
        del arg210_1
        buf85 = reinterpret_tensor(buf74, (196, 1024), (1024, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [out_124, out_125, out_126], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        extern_kernels.mm(reinterpret_tensor(buf84, (196, 256), (256, 1), 0), reinterpret_tensor(arg211_1, (256, 1024), (1, 256), 0), out=buf85)
        del arg211_1
        del buf84
        buf86 = reinterpret_tensor(buf85, (1, 1024, 14, 14), (200704, 1, 14336, 1024), 0); del buf85  # reuse
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_15.run(buf86, arg212_1, arg213_1, arg214_1, arg215_1, buf80, 200704, stream=stream0)
        del arg212_1
        del arg213_1
        del arg214_1
        del arg215_1
        ...
        # Topologically Sorted Source Nodes: [out_130, out_131, out_132], Original ATen: [aten.convolution, aten._native_batch_norm_legit_no_training, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_16.run(buf88, arg217_1, arg218_1, arg219_1, arg220_1, 100352, stream=stream0)
        del arg217_1
        del arg218_1
        del arg219_1
        del arg220_1
        ...
        assert_size_stride(buf89, (1, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg221_1
        buf90 = buf89; del buf89  # reuse
        # Topologically Sorted Source Nodes: [out_134, out_135, out_136], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_17.run(buf90, arg222_1, arg223_1, arg224_1, arg225_1, 25088, stream=stream0)
        del arg222_1
        del arg223_1
        del arg224_1
        del arg225_1
        ...
        assert_size_stride(buf92, (1, 2048, 7, 7), (100352, 1, 14336, 2048), 'torch.ops.aten.convolution.default')
        del arg231_1
        del buf86
        ...
        # Topologically Sorted Source Nodes: [out_134, out_135, out_136, out_137, input_8, out_138, out_139, out_140], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_18.run(buf93, arg227_1, arg228_1, arg229_1, arg230_1, buf92, arg232_1, arg233_1, arg234_1, arg235_1, buf94, 100352, stream=stream0)
        del arg227_1
        del arg228_1
        del arg229_1
        del arg230_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_17.run(buf96, arg237_1, arg238_1, arg239_1, arg240_1, 25088, stream=stream0)
        del arg237_1
        del arg238_1
        del arg239_1
        del arg240_1
        ...
        assert_size_stride(buf97, (1, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg241_1
        del buf96
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_17.run(buf98, arg242_1, arg243_1, arg244_1, arg245_1, 25088, stream=stream0)
        del arg242_1
        del arg243_1
        del arg244_1
        del arg245_1
        ...
        del arg246_1
        buf100 = reinterpret_tensor(buf99, (1, 2048, 7, 7), (100352, 1, 14336, 2048), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [out_139, out_144, out_145, out_146, out_147, out_148, out_149], Original ATen: [aten.relu, aten._native_batch_norm_legit_no_training, aten.convolution, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_add_convolution_relu_19.run(buf100, arg247_1, arg248_1, arg249_1, arg250_1, buf93, 100352, stream=stream0)
        del arg247_1
        del arg248_1
        del arg249_1
        del arg250_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_17.run(buf102, arg252_1, arg253_1, arg254_1, arg255_1, 25088, stream=stream0)
        del arg252_1
        del arg253_1
        del arg254_1
        del arg255_1
        ...
        assert_size_stride(buf103, (1, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg256_1
        del buf102
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused__native_batch_norm_legit_no_training_convolution_relu_17.run(buf104, arg257_1, arg258_1, arg259_1, arg260_1, 25088, stream=stream0)
        del arg257_1
        del arg258_1
        del arg259_1
        del arg260_1
        buf105 = reinterpret_tensor(buf93, (49, 2048), (2048, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [out_154, out_155, out_156], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution]
        ...
        # Topologically Sorted Source Nodes: [out_154, out_155, out_156, out_157, out_158, out_159, x_4], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu, aten.convolution, aten.add, aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused__native_batch_norm_legit_no_training_add_convolution_mean_relu_20.run(buf107, buf105, arg262_1, arg263_1, arg264_1, arg265_1, buf100, 2048, 49, stream=stream0)
        del arg262_1
        del arg263_1
        del arg264_1
        del arg265_1
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/3g/c3gduqijow5svvjjcbruqwld7urp733dflimffdhcdld6d4bgttn.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/63/c63uf75bycwyapy744rixr22kksqjxa3jttvcz22zoewgnu6t546.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/6o/c6o7laozjye2qvhkwllawkylwdc2hoi4et7oenyluibrrvi2zgmn.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/7j/c7jikac6g6hrp5pnrdjrodyvsabp3a5jvpxmsvnzootsy4khcd7d.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/ae/caewbhvw2a3jhyvhv5k45l266w3d7yg5z47vkp2b6r7ur4vvc5zm.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/az/cazklvkh655efhlfk2sbylmpf2zi6762qxgfgpyfaplnedqzjsjc.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/cj/ccj5pocxkfx6yg5ph6m4yx3r3gxjrrkhgqah2zsgam2zeznqsv3n.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/fm/cfmdp4dkimcgvyl2ftqkwtlrrwema5ck2f4fvrpqtfkvnga2oick.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/gi/cgil6hqp4q4lyvix7sb23kp4gche54bmj5hn53zqxhuu2vmz73ch.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/gp/cgp5qre2twqosszphtxed4cavdiveyqkebwsqobhd43pxdnn7nzm.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/ja/cja5rvgpfsdthjtpugt2uydu3vfjquvpa64mjgznkj3qubxatujs.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/ju/cju5ev5srzymwkyowdv5hyhghus4rfdzygjhol6fkfp6qb5n655l.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/mh/cmhxumtlhd35qr5faect4ksj7zdva3ogi43zh4t3zmgt7gjvfeso.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/nw/cnwwtdx73n4i3wu7m37i6f7rwrkqcolm4q4zop7duosjv43lcjh5.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/py/cpy2plana6zbwxeitv4q52mzgjoikcdqkprztwoojqdjzkkyb4yh.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/rt/crtnhy43pyhfruky6gdfxuengcleuhsj4dlp4y5fc7kwfsymvp25.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/3g/c3gduqijow5svvjjcbruqwld7urp733dflimffdhcdld6d4bgttn.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/63/c63uf75bycwyapy744rixr22kksqjxa3jttvcz22zoewgnu6t546.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/6o/c6o7laozjye2qvhkwllawkylwdc2hoi4et7oenyluibrrvi2zgmn.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/7j/c7jikac6g6hrp5pnrdjrodyvsabp3a5jvpxmsvnzootsy4khcd7d.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/ae/caewbhvw2a3jhyvhv5k45l266w3d7yg5z47vkp2b6r7ur4vvc5zm.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/az/cazklvkh655efhlfk2sbylmpf2zi6762qxgfgpyfaplnedqzjsjc.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/cj/ccj5pocxkfx6yg5ph6m4yx3r3gxjrrkhgqah2zsgam2zeznqsv3n.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/fm/cfmdp4dkimcgvyl2ftqkwtlrrwema5ck2f4fvrpqtfkvnga2oick.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/gi/cgil6hqp4q4lyvix7sb23kp4gche54bmj5hn53zqxhuu2vmz73ch.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/gp/cgp5qre2twqosszphtxed4cavdiveyqkebwsqobhd43pxdnn7nzm.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/ja/cja5rvgpfsdthjtpugt2uydu3vfjquvpa64mjgznkj3qubxatujs.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/ju/cju5ev5srzymwkyowdv5hyhghus4rfdzygjhol6fkfp6qb5n655l.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/mh/cmhxumtlhd35qr5faect4ksj7zdva3ogi43zh4t3zmgt7gjvfeso.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/nw/cnwwtdx73n4i3wu7m37i6f7rwrkqcolm4q4zop7duosjv43lcjh5.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/py/cpy2plana6zbwxeitv4q52mzgjoikcdqkprztwoojqdjzkkyb4yh.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/rt/crtnhy43pyhfruky6gdfxuengcleuhsj4dlp4y5fc7kwfsymvp25.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/uo/cuo4mnlvj757tkdbwzhgwqmwfal5abv7ydlgwqh6u5tboro2yydh.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/x5/cx5fgio4s3u54vncfdovx5oi752ktnwtkjent6kjdjslzcvlsatz.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/xc/cxcxcsw4irwyxtg3kymgct336n67apcjzls2zbgjwdiqgr3mjfto.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/xk/cxk2snbyqmsfoz3inyhfuduztwghgfp6t6nzwsiy62fra5ysawdm.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/tmpr6pet08t/yl/cylgvooxzn7bd6hiyxpwhtocfguxxmdg75lmrrqa2g5sv2don7ko.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/uo/cuo4mnlvj757tkdbwzhgwqmwfal5abv7ydlgwqh6u5tboro2yydh.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/x5/cx5fgio4s3u54vncfdovx5oi752ktnwtkjent6kjdjslzcvlsatz.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/xc/cxcxcsw4irwyxtg3kymgct336n67apcjzls2zbgjwdiqgr3mjfto.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/xk/cxk2snbyqmsfoz3inyhfuduztwghgfp6t6nzwsiy62fra5ysawdm.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-1rdlj89b/inductor/repeat_02/base/attempt_01/torchinductor/yl/cylgvooxzn7bd6hiyxpwhtocfguxxmdg75lmrrqa2g5sv2don7ko.py =====
