# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/2v/c2v5cqnipq3gjcz55ghsmshm54xewvto34ma6gzh7cy5wsta7c7p.py =====
# AOT ID: ['0_inference']
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/rd/crddz7i2hfomvnbtzww3u6cal3bvtcyfbrbkq7oacywi5b2a25qa.py
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/ki/ckizf6rhalxt7vthcmd4t6yoeubdum6bhnd2an3cwreg4ppagt6c.py
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/zk/czkypk3fa7r7vx63lkcdpt33deaa3jltbt735tmljauxsuxy2c2f.py
# Topologically Sorted Source Nodes: [out, out_1], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out => convolution_1
#   out_1 => relu_1
# Graph fragment:
#   %buf3 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0" = PlaceHolder[target=buf3]
#   %arg4_1 : Tensor "f32[64][1]cuda:0" = PlaceHolder[target=arg4_1]
#   %convolution_1 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%getitem, %arg3_1, %arg4_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/jg/cjg6yylfdoop5tansyjjo4rc437ros4cnqv2w3oxftahwnrybxwx.py
...
#   %add : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_2, %getitem), kwargs = {})
#   %relu_2 : Tensor "f32[1, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add,), kwargs = {})
#   return %relu_2
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/lc/clceaxs7lgzmmywle3euzomb4bfqva3qezha4jhfwr3udfdtjlcf.py
# Topologically Sorted Source Nodes: [out_10, out_11], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out_10 => convolution_5
#   out_11 => relu_5
# Graph fragment:
#   %buf11 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=buf11]
#   %arg12_1 : Tensor "f32[128][1]cuda:0" = PlaceHolder[target=arg12_1]
#   %convolution_5 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_4, %arg11_1, %arg12_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_5 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_5,), kwargs = {})
#   return %relu_5
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/hm/chmkcgyzjbvjmnv2ecwfuh74oybu5cd4ggpa5pzfpfk4m3sowc75.py
...
#   out_14 => relu_6
# Graph fragment:
#   %buf13 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=buf13]
#   %arg14_1 : Tensor "f32[128][1]cuda:0" = PlaceHolder[target=arg14_1]
#   %buf14 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=buf14]
#   %arg16_1 : Tensor "f32[128][1]cuda:0" = PlaceHolder[target=arg16_1]
#   %convolution_5 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_4, %arg11_1, %arg12_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_5 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_5,), kwargs = {})
#   %convolution_6 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_5, %arg13_1, %arg14_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %convolution_7 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_4, %arg15_1, %arg16_1, [2, 2], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_2 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_6, %convolution_7), kwargs = {})
#   %relu_6 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_2,), kwargs = {})
#   return %relu_6
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/7m/c7maxv4e7ygqvmxqb7vavwh5niopdvhs7zjbtdqnruwtcaedy4db.py
...
#   %convolution_8 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_6, %arg17_1, %arg18_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_7 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_8,), kwargs = {})
#   %convolution_9 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_7, %arg19_1, %arg20_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_3 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_9, %relu_6), kwargs = {})
#   %relu_8 : Tensor "f32[1, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_3,), kwargs = {})
#   return %relu_8
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/jz/cjzbdhmjuskeucf24qvgugyamlhl73cngtgkgawklv22eskli5uj.py
# Topologically Sorted Source Nodes: [out_20, out_21], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out_20 => convolution_10
#   out_21 => relu_9
# Graph fragment:
#   %buf20 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf20]
#   %arg22_1 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=arg22_1]
#   %convolution_10 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_8, %arg21_1, %arg22_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_9 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_10,), kwargs = {})
#   return %relu_9
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/nm/cnmhp6sbziezr34hnpl3d2htbbnzp7mq5l6qr4se5f5csqbjr5ul.py
...
#   out_24 => relu_10
# Graph fragment:
#   %buf22 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf22]
#   %arg24_1 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=arg24_1]
#   %buf23 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf23]
#   %arg26_1 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=arg26_1]
#   %convolution_10 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_8, %arg21_1, %arg22_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_9 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_10,), kwargs = {})
#   %convolution_11 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_9, %arg23_1, %arg24_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %convolution_12 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_8, %arg25_1, %arg26_1, [2, 2], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_4 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_11, %convolution_12), kwargs = {})
#   %relu_10 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_4,), kwargs = {})
#   return %relu_10
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/cr/ccrud3yudfcsfo7lacvah57cppuuwjxc5scdjxz44w7vhn7k62an.py
...
#   out_29 => relu_12
# Graph fragment:
#   %buf27 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf27]
...
#   %convolution_13 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_10, %arg27_1, %arg28_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_11 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_13,), kwargs = {})
#   %convolution_14 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_11, %arg29_1, %arg30_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_5 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_14, %relu_10), kwargs = {})
#   %relu_12 : Tensor "f32[1, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_5,), kwargs = {})
#   return %relu_12
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/v7/cv7yikdfrytbkospbsouxaro3tqcsureq3uweja4qmjvgf3ijm67.py
# Topologically Sorted Source Nodes: [out_30, out_31], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out_30 => convolution_15
#   out_31 => relu_13
# Graph fragment:
#   %buf29 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf29]
#   %arg32_1 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=arg32_1]
#   %convolution_15 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_12, %arg31_1, %arg32_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_13 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_15,), kwargs = {})
#   return %relu_13
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/bs/cbsiidlfhgoj4n5m4oa5txuv5r54du6hanr2ycby2b4lmsu75njb.py
...
#   out_34 => relu_14
# Graph fragment:
#   %buf31 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf31]
#   %arg34_1 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=arg34_1]
#   %buf32 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf32]
#   %arg36_1 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=arg36_1]
#   %convolution_15 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_12, %arg31_1, %arg32_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_13 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_15,), kwargs = {})
#   %convolution_16 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_13, %arg33_1, %arg34_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %convolution_17 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_12, %arg35_1, %arg36_1, [2, 2], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_6 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_16, %convolution_17), kwargs = {})
#   %relu_14 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_6,), kwargs = {})
#   return %relu_14
...
# kernel path: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/2b/c2bciae5eww7ke3fzhqygf7d77npgwnoacyx44mdubbs2uxntbny.py
...
#   x_3 => mean
# Graph fragment:
#   %buf36 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf36]
...
#   %buf37 : Tensor "f32[1, 512, 1, 1][512, 1, 512, 512]cuda:0" = PlaceHolder[target=buf37]
#   %convolution_18 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_14, %arg37_1, %arg38_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_15 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_18,), kwargs = {})
#   %convolution_19 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_15, %arg39_1, %arg40_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_7 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_19, %relu_14), kwargs = {})
#   %relu_16 : Tensor "f32[1, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_7,), kwargs = {})
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [out, out_1], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_2.run(buf4, arg4_1, 200704, stream=stream0)
        del arg4_1
        ...
        # Topologically Sorted Source Nodes: [out, out_1, out_2, out_3, out_4], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_3.run(buf6, arg6_1, buf2, 200704, stream=stream0)
        del arg6_1
        del buf2
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_2.run(buf8, arg8_1, 200704, stream=stream0)
        del arg8_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_3.run(buf10, arg10_1, buf6, 200704, stream=stream0)
        del arg10_1
        del buf6
        ...
        # Topologically Sorted Source Nodes: [out_10, out_11], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_4.run(buf12, arg12_1, 100352, stream=stream0)
        del arg12_1
        ...
        # Topologically Sorted Source Nodes: [out_10, out_11, out_12, input_1, out_13, out_14], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_5.run(buf15, arg14_1, buf14, arg16_1, 100352, stream=stream0)
        del arg14_1
        del arg16_1
        del buf14
        ...
        assert_size_stride(buf16, (1, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg17_1
        buf17 = buf16; del buf16  # reuse
        # Topologically Sorted Source Nodes: [out_15, out_16], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_4.run(buf17, arg18_1, 100352, stream=stream0)
        del arg18_1
        ...
        # Topologically Sorted Source Nodes: [out_15, out_16, out_17, out_18, out_19], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_6.run(buf19, arg20_1, buf15, 100352, stream=stream0)
        del arg20_1
        del buf15
        ...
        assert_size_stride(buf20, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg21_1
        buf21 = buf20; del buf20  # reuse
        # Topologically Sorted Source Nodes: [out_20, out_21], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_7.run(buf21, arg22_1, 50176, stream=stream0)
        del arg22_1
        ...
        assert_size_stride(buf22, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg23_1
        del buf21
        ...
        # Topologically Sorted Source Nodes: [out_20, out_21, out_22, input_2, out_23, out_24], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_8.run(buf24, arg24_1, buf23, arg26_1, 50176, stream=stream0)
        del arg24_1
        del arg26_1
        del buf23
        ...
        assert_size_stride(buf25, (1, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg27_1
        buf26 = buf25; del buf25  # reuse
        # Topologically Sorted Source Nodes: [out_25, out_26], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_7.run(buf26, arg28_1, 50176, stream=stream0)
        del arg28_1
        ...
        # Topologically Sorted Source Nodes: [out_25, out_26, out_27, out_28, out_29], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_9.run(buf28, arg30_1, buf24, 50176, stream=stream0)
        del arg30_1
        del buf24
        ...
        assert_size_stride(buf29, (1, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg31_1
        buf30 = buf29; del buf29  # reuse
        # Topologically Sorted Source Nodes: [out_30, out_31], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_10.run(buf30, arg32_1, 25088, stream=stream0)
        del arg32_1
        ...
        assert_size_stride(buf32, (1, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg35_1
        del buf28
        buf33 = buf31; del buf31  # reuse
        # Topologically Sorted Source Nodes: [out_30, out_31, out_32, input_3, out_33, out_34], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_11.run(buf33, arg34_1, buf32, arg36_1, 25088, stream=stream0)
        del arg34_1
        del arg36_1
        del buf32
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_10.run(buf35, arg38_1, 25088, stream=stream0)
        del arg38_1
        ...
        assert_size_stride(buf36, (1, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg39_1
        del buf35
        ...
        # Topologically Sorted Source Nodes: [out_35, out_36, out_37, out_38, out_39, x_3], Original ATen: [aten.convolution, aten.relu, aten.add, aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_convolution_mean_relu_12.run(buf38, buf36, arg40_1, buf33, 512, 49, stream=stream0)
        del arg40_1
        del buf33
        del buf36
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/2b/c2bciae5eww7ke3fzhqygf7d77npgwnoacyx44mdubbs2uxntbny.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/7m/c7maxv4e7ygqvmxqb7vavwh5niopdvhs7zjbtdqnruwtcaedy4db.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/bs/cbsiidlfhgoj4n5m4oa5txuv5r54du6hanr2ycby2b4lmsu75njb.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/cr/ccrud3yudfcsfo7lacvah57cppuuwjxc5scdjxz44w7vhn7k62an.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/hm/chmkcgyzjbvjmnv2ecwfuh74oybu5cd4ggpa5pzfpfk4m3sowc75.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/jz/cjzbdhmjuskeucf24qvgugyamlhl73cngtgkgawklv22eskli5uj.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/nm/cnmhp6sbziezr34hnpl3d2htbbnzp7mq5l6qr4se5f5csqbjr5ul.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/2b/c2bciae5eww7ke3fzhqygf7d77npgwnoacyx44mdubbs2uxntbny.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/7m/c7maxv4e7ygqvmxqb7vavwh5niopdvhs7zjbtdqnruwtcaedy4db.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/bs/cbsiidlfhgoj4n5m4oa5txuv5r54du6hanr2ycby2b4lmsu75njb.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/cr/ccrud3yudfcsfo7lacvah57cppuuwjxc5scdjxz44w7vhn7k62an.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/hm/chmkcgyzjbvjmnv2ecwfuh74oybu5cd4ggpa5pzfpfk4m3sowc75.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/jg/cjg6yylfdoop5tansyjjo4rc437ros4cnqv2w3oxftahwnrybxwx.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/jz/cjzbdhmjuskeucf24qvgugyamlhl73cngtgkgawklv22eskli5uj.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/ki/ckizf6rhalxt7vthcmd4t6yoeubdum6bhnd2an3cwreg4ppagt6c.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/lc/clceaxs7lgzmmywle3euzomb4bfqva3qezha4jhfwr3udfdtjlcf.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/nm/cnmhp6sbziezr34hnpl3d2htbbnzp7mq5l6qr4se5f5csqbjr5ul.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/rd/crddz7i2hfomvnbtzww3u6cal3bvtcyfbrbkq7oacywi5b2a25qa.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/v7/cv7yikdfrytbkospbsouxaro3tqcsureq3uweja4qmjvgf3ijm67.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/tmpe1_0wia5/zk/czkypk3fa7r7vx63lkcdpt33deaa3jltbt735tmljauxsuxy2c2f.py =====
...
# ===== inductor generated file: /tmp/cnnbench-compile-repeats-tat7zkpl/inductor/repeat_02/fold/attempt_01/torchinductor/v7/cv7yikdfrytbkospbsouxaro3tqcsureq3uweja4qmjvgf3ijm67.py =====
