# ===== inductor generated file: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/d6/cd6a35ls6q265weaxtdhfdy6bgfq7rx73zi2pswglxteulkn5wky.py =====
# AOT ID: ['0_inference']
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/5v/c5vkem6srcxedzazgvzrwwrd2s3vmu2kzaag5gxatp6zfb4dk75w.py
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/op/copdhukyru6cy4ehcr2opscmsem4625hh33kigflxrxc24tfmcib.py
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/sz/csztj2g6ubgipjgsjnbz3lneowpyvo5xed4dqrijbdmcupfdky2s.py
# Topologically Sorted Source Nodes: [out, out_1], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out => convolution_1
#   out_1 => relu_1
# Graph fragment:
#   %buf3 : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0" = PlaceHolder[target=buf3]
#   %arg4_1 : Tensor "f32[64][1]cuda:0" = PlaceHolder[target=arg4_1]
#   %convolution_1 : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%getitem, %arg3_1, %arg4_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/er/cerpueawhg36gszomhicyodncm5dgmik62sxwejqa5h6azblkdfe.py
...
#   %add : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_2, %getitem), kwargs = {})
#   %relu_2 : Tensor "f32[64, 64, 56, 56][200704, 1, 3584, 64]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add,), kwargs = {})
#   return %relu_2
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/mc/cmcyrrsj37ercvlonooubhgspp2ceeivroyubtn7usgreanrlslz.py
# Topologically Sorted Source Nodes: [out_10, out_11], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out_10 => convolution_5
#   out_11 => relu_5
# Graph fragment:
#   %buf11 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=buf11]
#   %arg12_1 : Tensor "f32[128][1]cuda:0" = PlaceHolder[target=arg12_1]
#   %convolution_5 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_4, %arg11_1, %arg12_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_5 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_5,), kwargs = {})
#   return %relu_5
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/z5/cz5ezcasppiybgete6cx6tvsvzydvvfy4krpgfkrl2k566jh6a7s.py
...
#   out_14 => relu_6
# Graph fragment:
#   %buf13 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=buf13]
#   %arg14_1 : Tensor "f32[128][1]cuda:0" = PlaceHolder[target=arg14_1]
#   %buf14 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=buf14]
#   %arg16_1 : Tensor "f32[128][1]cuda:0" = PlaceHolder[target=arg16_1]
#   %convolution_5 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_4, %arg11_1, %arg12_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_5 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_5,), kwargs = {})
#   %convolution_6 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_5, %arg13_1, %arg14_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %convolution_7 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_4, %arg15_1, %arg16_1, [2, 2], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_2 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_6, %convolution_7), kwargs = {})
#   %relu_6 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_2,), kwargs = {})
#   return %relu_6
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/zy/czy3lceujdpx7n6g4xbkz6vnlmmnbxej2axz6l7q6vh53kzovwdj.py
...
#   out_19 => relu_8
# Graph fragment:
#   %buf18 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0" = PlaceHolder[target=buf18]
...
#   %convolution_8 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_6, %arg17_1, %arg18_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_7 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_8,), kwargs = {})
#   %convolution_9 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_7, %arg19_1, %arg20_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_3 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_9, %relu_6), kwargs = {})
#   %relu_8 : Tensor "f32[64, 128, 28, 28][100352, 1, 3584, 128]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_3,), kwargs = {})
#   return %relu_8
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_convolution_relu_6', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 102760960}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/aj/caj2yaba36mmxstxf6iaycmhij2wehyq2t5qio2rbnbhipfgxxk4.py
# Topologically Sorted Source Nodes: [out_20, out_21], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out_20 => convolution_10
#   out_21 => relu_9
# Graph fragment:
#   %buf20 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf20]
#   %arg22_1 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=arg22_1]
#   %convolution_10 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_8, %arg21_1, %arg22_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_9 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_10,), kwargs = {})
#   return %relu_9
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/ta/ctah6bwcpftoduhpmf3b3hglb35gjuufd5lblxt4a24bp3cxm76t.py
...
#   out_24 => relu_10
# Graph fragment:
#   %buf22 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf22]
#   %arg24_1 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=arg24_1]
#   %buf23 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf23]
#   %arg26_1 : Tensor "f32[256][1]cuda:0" = PlaceHolder[target=arg26_1]
#   %convolution_10 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_8, %arg21_1, %arg22_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_9 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_10,), kwargs = {})
#   %convolution_11 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_9, %arg23_1, %arg24_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %convolution_12 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_8, %arg25_1, %arg26_1, [2, 2], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_4 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_11, %convolution_12), kwargs = {})
#   %relu_10 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_4,), kwargs = {})
#   return %relu_10
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=20, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_convolution_relu_8', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': '5C4E406C711B3861DF9C100323E0EC398E2F633BD8802E2E564CD4776AA7ED44', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'max_autotune': True, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'coordinate_descent_tuning': True, 'coordinate_descent_search_radius': 1, 'coordinate_descent_check_all_directions': False, 'tiling_scores': {'x': 51382272}},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/6s/c6stqyhqgxbvxdknimtcorr7o4m65c42ueej4pahfm3plnqmcpxn.py
...
#   out_29 => relu_12
# Graph fragment:
#   %buf27 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0" = PlaceHolder[target=buf27]
...
#   %convolution_13 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_10, %arg27_1, %arg28_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_11 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_13,), kwargs = {})
#   %convolution_14 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_11, %arg29_1, %arg30_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_5 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_14, %relu_10), kwargs = {})
#   %relu_12 : Tensor "f32[64, 256, 14, 14][50176, 1, 3584, 256]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_5,), kwargs = {})
#   return %relu_12
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/z3/cz3d3xx73ryjxw5uue2sqtujvo7j6ypufszaklle52v535s2nvno.py
# Topologically Sorted Source Nodes: [out_30, out_31], Original ATen: [aten.convolution, aten.relu]
# Source node to ATen node mapping:
#   out_30 => convolution_15
#   out_31 => relu_13
# Graph fragment:
#   %buf29 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf29]
#   %arg32_1 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=arg32_1]
#   %convolution_15 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_12, %arg31_1, %arg32_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_13 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_15,), kwargs = {})
#   return %relu_13
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/2i/c2ixemtgv6nx6d7aswhytgx7wyzpil5c5uptwbdpavg3ih6vmodj.py
...
#   out_34 => relu_14
# Graph fragment:
#   %buf31 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf31]
#   %arg34_1 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=arg34_1]
#   %buf32 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf32]
#   %arg36_1 : Tensor "f32[512][1]cuda:0" = PlaceHolder[target=arg36_1]
#   %convolution_15 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_12, %arg31_1, %arg32_1, [2, 2], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_13 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_15,), kwargs = {})
#   %convolution_16 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_13, %arg33_1, %arg34_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %convolution_17 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_12, %arg35_1, %arg36_1, [2, 2], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_6 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_16, %convolution_17), kwargs = {})
#   %relu_14 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.relu.default](args = (%add_6,), kwargs = {})
#   return %relu_14
...
# kernel path: /tmp/cnnbench-compile-repeats-pr6pj1t7/inductor/repeat_01/fold/attempt_01/torchinductor/tmpinpi2spm/7u/c7uny6lf4lpbvugeom3gg65l4s7a4qmljwsjwa6dt7ocz4l5hodi.py
...
#   x_3 => mean
# Graph fragment:
#   %buf36 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0" = PlaceHolder[target=buf36]
...
#   %buf37 : Tensor "f32[64, 512, 1, 1][512, 1, 32768, 32768]cuda:0" = PlaceHolder[target=buf37]
#   %convolution_18 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_14, %arg37_1, %arg38_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %relu_15 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%convolution_18,), kwargs = {})
#   %convolution_19 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%relu_15, %arg39_1, %arg40_1, [1, 1], [1, 1], [1, 1], False, [0, 0], 1), kwargs = {})
#   %add_7 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convolution_19, %relu_14), kwargs = {})
#   %relu_16 : Tensor "f32[64, 512, 7, 7][25088, 1, 3584, 512]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.relu.default](args = (%add_7,), kwargs = {})
...
def partition_0(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [out, out_1], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_2.run(buf4, arg4_1, 12845056, stream=stream0)
        del arg4_1
        ...
        # Topologically Sorted Source Nodes: [out, out_1, out_2, out_3, out_4], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_3.run(buf6, arg6_1, buf2, 12845056, stream=stream0)
        del arg6_1
        del buf2
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_2.run(buf8, arg8_1, 12845056, stream=stream0)
        del arg8_1
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_3.run(buf10, arg10_1, buf6, 12845056, stream=stream0)
        del arg10_1
        del buf6
        ...
        # Topologically Sorted Source Nodes: [out_10, out_11], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_4.run(buf12, arg12_1, 6422528, stream=stream0)
        del arg12_1
        ...
        # Topologically Sorted Source Nodes: [out_10, out_11, out_12, input_1, out_13, out_14], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_5.run(buf15, arg14_1, buf14, arg16_1, 6422528, stream=stream0)
        del arg14_1
        del arg16_1
        del buf14
        ...
        assert_size_stride(buf16, (64, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg17_1
        buf17 = buf16; del buf16  # reuse
        # Topologically Sorted Source Nodes: [out_15, out_16], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_4.run(buf17, arg18_1, 6422528, stream=stream0)
        del arg18_1
        ...
        assert_size_stride(buf18, (64, 128, 28, 28), (100352, 1, 3584, 128), 'torch.ops.aten.convolution.default')
        del arg19_1
        del buf17
        buf19 = buf18; del buf18  # reuse
        # Topologically Sorted Source Nodes: [out_15, out_16, out_17, out_18, out_19], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_6.run(buf19, arg20_1, buf15, 6422528, stream=stream0)
        del arg20_1
        del buf15
        ...
        assert_size_stride(buf20, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg21_1
        buf21 = buf20; del buf20  # reuse
        # Topologically Sorted Source Nodes: [out_20, out_21], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_7.run(buf21, arg22_1, 3211264, stream=stream0)
        del arg22_1
        ...
        assert_size_stride(buf22, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg23_1
        del buf21
        ...
        # Topologically Sorted Source Nodes: [out_20, out_21, out_22, input_2, out_23, out_24], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_8.run(buf24, arg24_1, buf23, arg26_1, 3211264, stream=stream0)
        del arg24_1
        del arg26_1
        del buf23
        ...
        assert_size_stride(buf25, (64, 256, 14, 14), (50176, 1, 3584, 256), 'torch.ops.aten.convolution.default')
        del arg27_1
        buf26 = buf25; del buf25  # reuse
        # Topologically Sorted Source Nodes: [out_25, out_26], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_7.run(buf26, arg28_1, 3211264, stream=stream0)
        del arg28_1
        ...
        # Topologically Sorted Source Nodes: [out_25, out_26, out_27, out_28, out_29], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_9.run(buf28, arg30_1, buf24, 3211264, stream=stream0)
        del arg30_1
        del buf24
        ...
        assert_size_stride(buf29, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg31_1
        buf30 = buf29; del buf29  # reuse
        # Topologically Sorted Source Nodes: [out_30, out_31], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_10.run(buf30, arg32_1, 1605632, stream=stream0)
        del arg32_1
        ...
        assert_size_stride(buf32, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg35_1
        del buf28
        buf33 = buf31; del buf31  # reuse
        # Topologically Sorted Source Nodes: [out_30, out_31, out_32, input_3, out_33, out_34], Original ATen: [aten.convolution, aten.relu, aten.add]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_convolution_relu_11.run(buf33, arg34_1, buf32, arg36_1, 1605632, stream=stream0)
        del arg34_1
        del arg36_1
        del buf32
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_10.run(buf35, arg38_1, 1605632, stream=stream0)
        del arg38_1
        ...
        assert_size_stride(buf36, (64, 512, 7, 7), (25088, 1, 3584, 512), 'torch.ops.aten.convolution.default')
        del arg39_1
        del buf35
        buf37 = empty_strided_cuda((64, 512, 1, 1), (512, 1, 32768, 32768), torch.float32)
        buf38 = reinterpret_tensor(buf37, (64, 512, 1, 1), (512, 1, 1, 1), 0); del buf37  # reuse
        # Topologically Sorted Source Nodes: [out_35, out_36, out_37, out_38, out_39, x_3], Original ATen: [aten.convolution, aten.relu, aten.add, aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused_add