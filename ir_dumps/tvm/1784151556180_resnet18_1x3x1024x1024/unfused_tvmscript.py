...
class Module:
            ...
            for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(T.int64(512), thread="threadIdx.x"):
                for rv0, rv1 in T.grid(T.int64(32), T.int64(32)):
                    with T.block("adaptive_pool_sum"):
                        ...
                        T.reads(lv85[v_ax0, v_ax1, v_ax2 * T.int64(32) + v_rv0, v_ax3 * T.int64(32) + v_rv1])
                        T.writes(adaptive_pool_sum[v_ax0, v_ax1, v_ax2, v_ax3])
                        with T.init():
                            adaptive_pool_sum[v_ax0, v_ax1, v_ax2, v_ax3] = T.float32(0.0)
                        adaptive_pool_sum[v_ax0, v_ax1, v_ax2, v_ax3] = adaptive_pool_sum[v_ax0, v_ax1, v_ax2, v_ax3] + lv85[v_ax0, v_ax1, v_ax2 * T.int64(32) + v_rv0, v_ax3 * T.int64(32) + v_rv1]
        for ax0_ax1_ax2_ax3_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(T.int64(512), thread="threadIdx.x"):
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(128), thread="threadIdx.x"):
                with T.block("T_divide_1"):
                    ...
                    T.writes(T_divide_1[v_ax0])
                    T_divide_1[v_ax0] = lv23_red[v_ax0] * T.float32(6.103515625e-05)
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(128), thread="threadIdx.x"):
                with T.block("T_multiply_2"):
                    v_ax0 = T.axis.spatial(T.int64(128), ax0_fused_0 * T.int64(128) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(256), thread="threadIdx.x"):
                with T.block("T_divide_1"):
                    ...
                    T.writes(T_divide_1[v_ax0])
                    T_divide_1[v_ax0] = lv44_red[v_ax0] * T.float32(0.000244140625)
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(256), thread="threadIdx.x"):
                with T.block("T_multiply_2"):
                    v_ax0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(256) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(512), thread="threadIdx.x"):
                with T.block("T_divide_1"):
                    ...
                    T.writes(T_divide_1[v_ax0])
                    T_divide_1[v_ax0] = lv65_red[v_ax0] * T.float32(0.0009765625)
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(512), thread="threadIdx.x"):
                with T.block("T_multiply_2"):
                    v_ax0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(512) + ax0_fused_1)
            ...
            for i0_i1_i2_i3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for i0_i1_i2_i3_fused_0 in range(T.int64(17)):
                    with T.block("pad_temp"):
                        ...
                        T.writes(pad_temp[v_i0, v_i1, v_i2, v_i3])
                        pad_temp[v_i0, v_i1, v_i2, v_i3] = T.if_then_else(T.int64(1) <= v_i2 and v_i2 < T.int64(257) and T.int64(1) <= v_i3 and v_i3 < T.int64(257), lv4[v_i0, v_i1, v_i2 - T.int64(1), v_i3 - T.int64(1)], T.float32(0.0))
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
            ...
            for i0_i1_i2_i3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for i0_i1_i2_i3_fused_0 in range(T.int64(17)):
                    with T.block("pad_temp"):
                        ...
                        T.writes(pad_temp[v_i0, v_i1, v_i2, v_i3])
                        pad_temp[v_i0, v_i1, v_i2, v_i3] = T.if_then_else(T.int64(1) <= v_i2 and v_i2 < T.int64(257) and T.int64(1) <= v_i3 and v_i3 < T.int64(257), lv22[v_i0, v_i1, v_i2 - T.int64(1), v_i3 - T.int64(1)], T.float32(0.0))
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for nn_ff_yy_xx_fused_0, rc, ry, rx in T.grid(T.int64(8), T.int64(64), T.int64(3), T.int64(3)):
                    with T.block("conv2d_nchw"):
                        v_nn = T.axis.spatial(T.int64(1), T.int64(0))
            ...
            for i0_i1_i2_i3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for i0_i1_i2_i3_fused_0 in range(T.int64(9)):
                    with T.block("pad_temp"):
                        ...
                        T.writes(pad_temp[v_i0, v_i1, v_i2, v_i3])
                        pad_temp[v_i0, v_i1, v_i2, v_i3] = T.if_then_else(T.int64(1) <= v_i2 and v_i2 < T.int64(129) and T.int64(1) <= v_i3 and v_i3 < T.int64(129), lv26[v_i0, v_i1, v_i2 - T.int64(1), v_i3 - T.int64(1)], T.float32(0.0))
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
    ...
    def conv2d4(lv22: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32"), B: T.Buffer((T.int64(128), T.int64(64), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(128), T.int64(128), T.int64(128)), "float32")):
        ...
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for nn_ff_yy_xx_fused_0, rc, ry, rx in T.grid(T.int64(8), T.int64(64), T.int64(1), T.int64(1)):
                    with T.block("conv2d_nchw"):
                        v_nn = T.axis.spatial(T.int64(1), T.int64(0))
                        v_ff = T.axis.spatial(T.int64(128), (nn_ff_yy_xx_fused_0 * T.int64(262144) + nn_ff_yy_xx_fused_1 * T.int64(1024) + nn_ff_yy_xx_fused_2) // T.int64(16384))
                        v_yy = T.axis.spatial(T.int64(128), (nn_ff_yy_xx_fused_0 * T.int64(262144) + nn_ff_yy_xx_fused_1 * T.int64(1024) + nn_ff_yy_xx_fused_2) % T.int64(16384) // T.int64(128))
            ...
            for i0_i1_i2_i3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for i0_i1_i2_i3_fused_0 in range(T.int64(9)):
                    with T.block("pad_temp"):
                        ...
                        T.writes(pad_temp[v_i0, v_i1, v_i2, v_i3])
                        pad_temp[v_i0, v_i1, v_i2, v_i3] = T.if_then_else(T.int64(1) <= v_i2 and v_i2 < T.int64(129) and T.int64(1) <= v_i3 and v_i3 < T.int64(129), lv43[v_i0, v_i1, v_i2 - T.int64(1), v_i3 - T.int64(1)], T.float32(0.0))
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
            ...
            for i0_i1_i2_i3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for i0_i1_i2_i3_fused_0 in range(T.int64(5)):
                    with T.block("pad_temp"):
                        ...
                        T.writes(pad_temp[v_i0, v_i1, v_i2, v_i3])
                        pad_temp[v_i0, v_i1, v_i2, v_i3] = T.if_then_else(T.int64(1) <= v_i2 and v_i2 < T.int64(65) and T.int64(1) <= v_i3 and v_i3 < T.int64(65), lv47[v_i0, v_i1, v_i2 - T.int64(1), v_i3 - T.int64(1)], T.float32(0.0))
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
            ...
            for i0_i1_i2_i3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for i0_i1_i2_i3_fused_0 in range(T.int64(5)):
                    with T.block("pad_temp"):
                        ...
                        T.writes(pad_temp[v_i0, v_i1, v_i2, v_i3])
                        pad_temp[v_i0, v_i1, v_i2, v_i3] = T.if_then_else(T.int64(1) <= v_i2 and v_i2 < T.int64(65) and T.int64(1) <= v_i3 and v_i3 < T.int64(65), lv64[v_i0, v_i1, v_i2 - T.int64(1), v_i3 - T.int64(1)], T.float32(0.0))
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
            ...
            for i0_i1_i2_i3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for i0_i1_i2_i3_fused_0 in range(T.int64(3)):
                    with T.block("pad_temp"):
                        ...
                        T.writes(pad_temp[v_i0, v_i1, v_i2, v_i3])
                        pad_temp[v_i0, v_i1, v_i2, v_i3] = T.if_then_else(T.int64(1) <= v_i2 and v_i2 < T.int64(33) and T.int64(1) <= v_i3 and v_i3 < T.int64(33), lv68[v_i0, v_i1, v_i2 - T.int64(1), v_i3 - T.int64(1)], T.float32(0.0))
        for nn_ff_yy_xx_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for nn_ff_yy_xx_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
    ...
    def fused_add1_relu2(lv28_0: T.Buffer((T.int64(1), T.int64(128), T.int64(128), T.int64(128)), "float32"), lv31_0: T.Buffer((T.int64(1), T.int64(128), T.int64(128), T.int64(128)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(128), T.int64(128), T.int64(128)), "float32")):
        ...
        # with T.block("root"):
        T_add_intermediate = T.alloc_buffer((T.int64(1), T.int64(128), T.int64(128), T.int64(128)))
        for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for ax0_ax1_ax2_ax3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for ax0_ax1_ax2_ax3_fused_0 in range(T.int64(8)):
                    with T.block("T_add"):
    ...
    def fused_add2_relu3(lv49_0: T.Buffer((T.int64(1), T.int64(256), T.int64(64), T.int64(64)), "float32"), lv52_0: T.Buffer((T.int64(1), T.int64(256), T.int64(64), T.int64(64)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(256), T.int64(64), T.int64(64)), "float32")):
        T.func_attr({"target": T.target({"arch": "sm_86", "keys": ["cuda", "gpu"], "kind": "cuda", "max_num_threads": 1024, "max_shared_memory_per_block": 49152, "max_threads_per_block": 1024, "tag": "", "thread_warp_size": 32}), "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        T_add_intermediate = T.alloc_buffer((T.int64(1), T.int64(256), T.int64(64), T.int64(64)))
        for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for ax0_ax1_ax2_ax3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for ax0_ax1_ax2_ax3_fused_0 in range(T.int64(4)):
                    with T.block("T_add"):
    ...
    def fused_add3_relu4(lv70_0: T.Buffer((T.int64(1), T.int64(512), T.int64(32), T.int64(32)), "float32"), lv73_0: T.Buffer((T.int64(1), T.int64(512), T.int64(32), T.int64(32)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(512), T.int64(32), T.int64(32)), "float32")):
        T.func_attr({"target": T.target({"arch": "sm_86", "keys": ["cuda", "gpu"], "kind": "cuda", "max_num_threads": 1024, "max_shared_memory_per_block": 49152, "max_threads_per_block": 1024, "tag": "", "thread_warp_size": 32}), "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        T_add_intermediate = T.alloc_buffer((T.int64(1), T.int64(512), T.int64(32), T.int64(32)))
        for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for ax0_ax1_ax2_ax3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for ax0_ax1_ax2_ax3_fused_0 in range(T.int64(2)):
                    with T.block("T_add"):
    ...
    def fused_add_relu1(lv10_0: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32"), lv4: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32")):
        T.func_attr({"target": T.target({"arch": "sm_86", "keys": ["cuda", "gpu"], "kind": "cuda", "max_num_threads": 1024, "max_shared_memory_per_block": 49152, "max_threads_per_block": 1024, "tag": "", "thread_warp_size": 32}), "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        T_add_intermediate = T.alloc_buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)))
        for ax0_ax1_ax2_ax3_fused_1 in T.thread_binding(T.int64(256), thread="blockIdx.x"):
            for ax0_ax1_ax2_ax3_fused_2 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                for ax0_ax1_ax2_ax3_fused_0 in range(T.int64(16)):
                    with T.block("T_add"):
    ...
    def main(inp_0: R.Tensor((1, 3, 1024, 1024), dtype="float32")) -> R.Tensor((1, 1000), dtype="float32"):
        ...
        with R.dataflow():
            ...
            lv9 = R.call_tir(cls.conv2d1, (lv3, metadata["relax.expr.Constant"][10]), out_sinfo=R.Tensor((1, 64, 256, 256), dtype="float32"))
            ...
            lv5_1 = R.call_tir(cls.fused_add_relu1, (lv4_1, lv4), out_sinfo=R.Tensor((1, 64, 256, 256), dtype="float32"))
            lv14 = R.call_tir(cls.conv2d1, (lv5_1, metadata["relax.expr.Constant"][15]), out_sinfo=R.Tensor((1, 64, 256, 256), dtype="float32"))
            lv15 = R.call_tir(cls.batch_norm1, (lv14, metadata["relax.expr.Constant"][16], metadata["relax.expr.Constant"][17], metadata["relax.expr.Constant"][18], metadata["relax.expr.Constant"][19]), out_sinfo=[R.Tensor((1, 64, 256, 256), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")])
            lv6_1: R.Tensor((1, 64, 256, 256), dtype="float32") = lv15[0]
            lv7 = R.call_tir(cls.fused_relu1, (lv6_1,), out_sinfo=R.Tensor((1, 64, 256, 256), dtype="float32"))
            lv18 = R.call_tir(cls.conv2d1, (lv7, metadata["relax.expr.Constant"][20]), out_sinfo=R.Tensor((1, 64, 256, 256), dtype="float32"))
            lv19 = R.call_tir(cls.batch_norm1, (lv18, metadata["relax.expr.Constant"][21], metadata["relax.expr.Constant"][22], metadata["relax.expr.Constant"][23], metadata["relax.expr.Constant"][24]), out_sinfo=[R.Tensor((1, 64, 256, 256), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")])
            lv8: R.Tensor((1, 64, 256, 256), dtype="float32") = lv19[0]
            lv9_1 = R.call_tir(cls.fused_add_relu1, (lv8, lv5_1), out_sinfo=R.Tensor((1, 64, 256, 256), dtype="float32"))
            lv23 = R.call_tir(cls.conv2d2, (lv9_1, metadata["relax.expr.Constant"][25]), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv24 = R.call_tir(cls.batch_norm2, (lv23, metadata["relax.expr.Constant"][26], metadata["relax.expr.Constant"][27], metadata["relax.expr.Constant"][28], metadata["relax.expr.Constant"][29]), out_sinfo=[R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")])
            lv10_1: R.Tensor((1, 128, 128, 128), dtype="float32") = lv24[0]
            lv11 = R.call_tir(cls.fused_relu2, (lv10_1,), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv27 = R.call_tir(cls.conv2d3, (lv11, metadata["relax.expr.Constant"][30]), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv28 = R.call_tir(cls.batch_norm2, (lv27, metadata["relax.expr.Constant"][31], metadata["relax.expr.Constant"][32], metadata["relax.expr.Constant"][33], metadata["relax.expr.Constant"][34]), out_sinfo=[R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")])
            lv30 = R.call_tir(cls.conv2d4, (lv9_1, metadata["relax.expr.Constant"][35]), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv31 = R.call_tir(cls.batch_norm2, (lv30, metadata["relax.expr.Constant"][36], metadata["relax.expr.Constant"][37], metadata["relax.expr.Constant"][38], metadata["relax.expr.Constant"][39]), out_sinfo=[R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")])
            lv12: R.Tensor((1, 128, 128, 128), dtype="float32") = lv28[0]
            lv13: R.Tensor((1, 128, 128, 128), dtype="float32") = lv31[0]
            lv14_1 = R.call_tir(cls.fused_add1_relu2, (lv12, lv13), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv35 = R.call_tir(cls.conv2d3, (lv14_1, metadata["relax.expr.Constant"][40]), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv36 = R.call_tir(cls.batch_norm2, (lv35, metadata["relax.expr.Constant"][41], metadata["relax.expr.Constant"][42], metadata["relax.expr.Constant"][43], metadata["relax.expr.Constant"][44]), out_sinfo=[R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")])
            lv15_1: R.Tensor((1, 128, 128, 128), dtype="float32") = lv36[0]
            lv16 = R.call_tir(cls.fused_relu2, (lv15_1,), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv39 = R.call_tir(cls.conv2d3, (lv16, metadata["relax.expr.Constant"][45]), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv40 = R.call_tir(cls.batch_norm2, (lv39, metadata["relax.expr.Constant"][46], metadata["relax.expr.Constant"][47], metadata["relax.expr.Constant"][48], metadata["relax.expr.Constant"][49]), out_sinfo=[R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")])
            lv17: R.Tensor((1, 128, 128, 128), dtype="float32") = lv40[0]
            lv18_1 = R.call_tir(cls.fused_add1_relu2, (lv17, lv14_1), out_sinfo=R.Tensor((1, 128, 128, 128), dtype="float32"))
            lv44 = R.call_tir(cls.conv2d5, (lv18_1, metadata["relax.expr.Constant"][50]), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv45 = R.call_tir(cls.batch_norm3, (lv44, metadata["relax.expr.Constant"][51], metadata["relax.expr.Constant"][52], metadata["relax.expr.Constant"][53], metadata["relax.expr.Constant"][54]), out_sinfo=[R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv19_1: R.Tensor((1, 256, 64, 64), dtype="float32") = lv45[0]
            lv20 = R.call_tir(cls.fused_relu3, (lv19_1,), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv48 = R.call_tir(cls.conv2d6, (lv20, metadata["relax.expr.Constant"][55]), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv49 = R.call_tir(cls.batch_norm3, (lv48, metadata["relax.expr.Constant"][56], metadata["relax.expr.Constant"][57], metadata["relax.expr.Constant"][58], metadata["relax.expr.Constant"][59]), out_sinfo=[R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv51 = R.call_tir(cls.conv2d7, (lv18_1, metadata["relax.expr.Constant"][60]), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv52 = R.call_tir(cls.batch_norm3, (lv51, metadata["relax.expr.Constant"][61], metadata["relax.expr.Constant"][62], metadata["relax.expr.Constant"][63], metadata["relax.expr.Constant"][64]), out_sinfo=[R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv21: R.Tensor((1, 256, 64, 64), dtype="float32") = lv49[0]
            lv22: R.Tensor((1, 256, 64, 64), dtype="float32") = lv52[0]
            lv23_1 = R.call_tir(cls.fused_add2_relu3, (lv21, lv22), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv56 = R.call_tir(cls.conv2d6, (lv23_1, metadata["relax.expr.Constant"][65]), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv57 = R.call_tir(cls.batch_norm3, (lv56, metadata["relax.expr.Constant"][66], metadata["relax.expr.Constant"][67], metadata["relax.expr.Constant"][68], metadata["relax.expr.Constant"][69]), out_sinfo=[R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv24_1: R.Tensor((1, 256, 64, 64), dtype="float32") = lv57[0]
            lv25 = R.call_tir(cls.fused_relu3, (lv24_1,), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv60 = R.call_tir(cls.conv2d6, (lv25, metadata["relax.expr.Constant"][70]), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv61 = R.call_tir(cls.batch_norm3, (lv60, metadata["relax.expr.Constant"][71], metadata["relax.expr.Constant"][72], metadata["relax.expr.Constant"][73], metadata["relax.expr.Constant"][74]), out_sinfo=[R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")])
            lv26: R.Tensor((1, 256, 64, 64), dtype="float32") = lv61[0]
            lv27_1 = R.call_tir(cls.fused_add2_relu3, (lv26, lv23_1), out_sinfo=R.Tensor((1, 256, 64, 64), dtype="float32"))
            lv65 = R.call_tir(cls.conv2d8, (lv27_1, metadata["relax.expr.Constant"][75]), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv66 = R.call_tir(cls.batch_norm4, (lv65, metadata["relax.expr.Constant"][76], metadata["relax.expr.Constant"][77], metadata["relax.expr.Constant"][78], metadata["relax.expr.Constant"][79]), out_sinfo=[R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv28_1: R.Tensor((1, 512, 32, 32), dtype="float32") = lv66[0]
            lv29 = R.call_tir(cls.fused_relu4, (lv28_1,), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv69 = R.call_tir(cls.conv2d9, (lv29, metadata["relax.expr.Constant"][80]), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv70 = R.call_tir(cls.batch_norm4, (lv69, metadata["relax.expr.Constant"][81], metadata["relax.expr.Constant"][82], metadata["relax.expr.Constant"][83], metadata["relax.expr.Constant"][84]), out_sinfo=[R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv72 = R.call_tir(cls.conv2d10, (lv27_1, metadata["relax.expr.Constant"][85]), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv73 = R.call_tir(cls.batch_norm4, (lv72, metadata["relax.expr.Constant"][86], metadata["relax.expr.Constant"][87], metadata["relax.expr.Constant"][88], metadata["relax.expr.Constant"][89]), out_sinfo=[R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv30_1: R.Tensor((1, 512, 32, 32), dtype="float32") = lv70[0]
            lv31_1: R.Tensor((1, 512, 32, 32), dtype="float32") = lv73[0]
            lv32 = R.call_tir(cls.fused_add3_relu4, (lv30_1, lv31_1), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv77 = R.call_tir(cls.conv2d9, (lv32, metadata["relax.expr.Constant"][90]), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv78 = R.call_tir(cls.batch_norm4, (lv77, metadata["relax.expr.Constant"][91], metadata["relax.expr.Constant"][92], metadata["relax.expr.Constant"][93], metadata["relax.expr.Constant"][94]), out_sinfo=[R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv33: R.Tensor((1, 512, 32, 32), dtype="float32") = lv78[0]
            lv34 = R.call_tir(cls.fused_relu4, (lv33,), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv81 = R.call_tir(cls.conv2d9, (lv34, metadata["relax.expr.Constant"][95]), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
            lv82 = R.call_tir(cls.batch_norm4, (lv81, metadata["relax.expr.Constant"][96], metadata["relax.expr.Constant"][97], metadata["relax.expr.Constant"][98], metadata["relax.expr.Constant"][99]), out_sinfo=[R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")])
            lv35_1: R.Tensor((1, 512, 32, 32), dtype="float32") = lv82[0]
            lv36_1 = R.call_tir(cls.fused_add3_relu4, (lv35_1, lv32), out_sinfo=R.Tensor((1, 512, 32, 32), dtype="float32"))
