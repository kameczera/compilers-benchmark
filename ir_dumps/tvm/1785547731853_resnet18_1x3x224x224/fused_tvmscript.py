...
class Module:
    ...
    def adaptive_avg_pool2d(lv85: T.Buffer((T.int64(1), T.int64(512), T.int64(7), T.int64(7)), "float32"), adaptive_pool_avg: T.Buffer((T.int64(1), T.int64(512), T.int64(1), T.int64(1)), "float32")):
        ...
        adaptive_pool_sum_rf_local = T.alloc_buffer((T.int64(32), T.int64(1), T.int64(512), T.int64(1), T.int64(1)), scope="local")
            ...
            for ax1_ax2_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x", annotations={"pragma_auto_unroll_max_step": 256, "pragma_unroll_explicit": 1}):
                ...
                for ax1_ax2_fused_0, u in T.grid(T.int64(2), 1):
                    with T.block("adaptive_pool_sum_rf_update"):
                        ...
                        T.reads(adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)], lv85[T.int64(0), v0, (vax1_ax2_fused_0 * T.int64(32) + vax1_ax2_fused_1) // T.int64(7), (vax1_ax2_fused_0 * T.int64(32) + vax1_ax2_fused_1) % T.int64(7)])
                        T.writes(adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)])
                        adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)] = adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)] + lv85[T.int64(0), v0, (vax1_ax2_fused_0 * T.int64(32) + vax1_ax2_fused_1) // T.int64(7), (vax1_ax2_fused_0 * T.int64(32) + vax1_ax2_fused_1) % T.int64(7)]
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv23_red[v0] * T.float32(0.0012755102040816326))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(128), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(28), T.int64(28)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv23[T.int64(0), v0, v1, v2] - lv23_red[v0] * T.float32(0.0012755102040816326)) * (lv23[T.int64(0), v0, v1, v2] - lv23_red[v0] * T.float32(0.0012755102040816326))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(128), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv44_red[v0] * T.float32(0.0051020408163265302))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(14), T.int64(14)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv44[T.int64(0), v0, v1, v2] - lv44_red[v0] * T.float32(0.0051020408163265302)) * (lv44[T.int64(0), v0, v1, v2] - lv44_red[v0] * T.float32(0.0051020408163265302))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv65_red[v0] * T.float32(0.020408163265306121))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(7), T.int64(7)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv65[T.int64(0), v0, v1, v2] - lv65_red[v0] * T.float32(0.020408163265306121)) * (lv65[T.int64(0), v0, v1, v2] - lv65_red[v0] * T.float32(0.020408163265306121))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv4[T.int64(0), v2 // T.int64(9), v1 // T.int64(56) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(56) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(56) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(56) + v2 // T.int64(3) % T.int64(3) < T.int64(57) and T.int64(1) <= v1 % T.int64(56) + v2 % T.int64(3) and v1 % T.int64(56) + v2 % T.int64(3) < T.int64(57), lv4[T.int64(0), v2 // T.int64(9), v1 // T.int64(56) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(56) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d10(lv64: T.Buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)), "float32"), B: T.Buffer((T.int64(512), T.int64(256), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(512), T.int64(7), T.int64(7)), "float32")):
        ...
        pad_temp_reindex_pad_shared = T.alloc_buffer((T.int64(1), T.int64(64), T.int64(256)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        T.reads(lv64[T.int64(0), v2, v1 // T.int64(7) * T.int64(2), v1 % T.int64(7) * T.int64(2)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(49), lv64[T.int64(0), v2, v1 // T.int64(7) * T.int64(2), v1 % T.int64(7) * T.int64(2)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d2(lv22: T.Buffer((T.int64(1), T.int64(64), T.int64(56), T.int64(56)), "float32"), B: T.Buffer((T.int64(128), T.int64(64), T.int64(3), T.int64(3)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)), "float32")):
        ...
        pad_temp_reindex_pad_shared = T.alloc_buffer((T.int64(1), T.int64(800), T.int64(576)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        v2 = T.axis.spatial(T.int64(576), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv22[T.int64(0), v2 // T.int64(9), v1 // T.int64(28) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(28) * T.int64(2) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(784), T.if_then_else(T.int64(1) <= v1 // T.int64(28) * T.int64(2) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(28) * T.int64(2) + v2 // T.int64(3) % T.int64(3) < T.int64(57) and T.int64(1) <= v1 % T.int64(28) * T.int64(2) + v2 % T.int64(3) and v1 % T.int64(28) * T.int64(2) + v2 % T.int64(3) < T.int64(57), lv22[T.int64(0), v2 // T.int64(9), v1 // T.int64(28) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(28) * T.int64(2) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0)), T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        T.reads(lv26[T.int64(0), v2 // T.int64(9), v1 // T.int64(28) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(28) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(784), T.if_then_else(T.int64(1) <= v1 // T.int64(28) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(28) + v2 // T.int64(3) % T.int64(3) < T.int64(29) and T.int64(1) <= v1 % T.int64(28) + v2 % T.int64(3) and v1 % T.int64(28) + v2 % T.int64(3) < T.int64(29), lv26[T.int64(0), v2 // T.int64(9), v1 // T.int64(28) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(28) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0)), T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d4(lv22: T.Buffer((T.int64(1), T.int64(64), T.int64(56), T.int64(56)), "float32"), B: T.Buffer((T.int64(128), T.int64(64), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)), "float32")):
        ...
        # with T.block("root"):
        conv2d_nchw_reindex_pad_local = T.alloc_buffer((T.int64(1), T.int64(800), T.int64(128)), scope="local")
        pad_temp_reindex_pad_shared = T.alloc_buffer((T.int64(1), T.int64(800), T.int64(64)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        T.reads(lv22[T.int64(0), v2, v1 // T.int64(28) * T.int64(2), v1 % T.int64(28) * T.int64(2)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(784), lv22[T.int64(0), v2, v1 // T.int64(28) * T.int64(2), v1 % T.int64(28) * T.int64(2)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d5(lv43: T.Buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)), "float32"), B: T.Buffer((T.int64(256), T.int64(128), T.int64(3), T.int64(3)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)), "float32")):
        ...
        pad_temp_reindex_pad_shared = T.alloc_buffer((T.int64(1), T.int64(224), T.int64(1152)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        v2 = T.axis.spatial(T.int64(1152), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv43[T.int64(0), v2 // T.int64(9), v1 // T.int64(14) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(14) * T.int64(2) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(196), T.if_then_else(T.int64(1) <= v1 // T.int64(14) * T.int64(2) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(14) * T.int64(2) + v2 // T.int64(3) % T.int64(3) < T.int64(29) and T.int64(1) <= v1 % T.int64(14) * T.int64(2) + v2 % T.int64(3) and v1 % T.int64(14) * T.int64(2) + v2 % T.int64(3) < T.int64(29), lv43[T.int64(0), v2 // T.int64(9), v1 // T.int64(14) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(14) * T.int64(2) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0)), T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        T.reads(lv47[T.int64(0), v2 // T.int64(9), v1 // T.int64(14) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(14) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(196), T.if_then_else(T.int64(1) <= v1 // T.int64(14) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(14) + v2 // T.int64(3) % T.int64(3) < T.int64(15) and T.int64(1) <= v1 % T.int64(14) + v2 % T.int64(3) and v1 % T.int64(14) + v2 % T.int64(3) < T.int64(15), lv47[T.int64(0), v2 // T.int64(9), v1 // T.int64(14) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(14) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0)), T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d7(lv43: T.Buffer((T.int64(1), T.int64(128), T.int64(28), T.int64(28)), "float32"), B: T.Buffer((T.int64(256), T.int64(128), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)), "float32")):
        ...
        # with T.block("root"):
        conv2d_nchw_reindex_pad_local = T.alloc_buffer((T.int64(1), T.int64(224), T.int64(256)), scope="local")
        pad_temp_reindex_pad_shared = T.alloc_buffer((T.int64(1), T.int64(224), T.int64(128)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        T.reads(lv43[T.int64(0), v2, v1 // T.int64(14) * T.int64(2), v1 % T.int64(14) * T.int64(2)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(196), lv43[T.int64(0), v2, v1 // T.int64(14) * T.int64(2), v1 % T.int64(14) * T.int64(2)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d8(lv64: T.Buffer((T.int64(1), T.int64(256), T.int64(14), T.int64(14)), "float32"), B: T.Buffer((T.int64(512), T.int64(256), T.int64(3), T.int64(3)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(512), T.int64(7), T.int64(7)), "float32")):
        ...
        # with T.block("root"):
        conv2d_nchw_reindex_pad_local = T.alloc_buffer((T.int64(1), T.int64(64), T.int64(512)), scope="local")
        pad_temp_reindex_pad_shared = T.alloc_buffer((T.int64(1), T.int64(64), T.int64(2304)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_pad_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(64), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(2304), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv64[T.int64(0), v2 // T.int64(9), v1 // T.int64(7) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(7) * T.int64(2) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_pad_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_pad_shared[v0, v1, v2] = T.if_then_else(v1 < T.int64(49), T.if_then_else(T.int64(1) <= v1 // T.int64(7) * T.int64(2) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(7) * T.int64(2) + v2 // T.int64(3) % T.int64(3) < T.int64(15) and T.int64(1) <= v1 % T.int64(7) * T.int64(2) + v2 % T.int64(3) and v1 % T.int64(7) * T.int64(2) + v2 % T.int64(3) < T.int64(15), lv64[T.int64(0), v2 // T.int64(9), v1 // T.int64(7) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(7) * T.int64(2) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0)), T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def main(inp_0: R.Tensor((1, 3, 224, 224), dtype="float32")) -> R.Tensor((1, 1000), dtype="float32"):
        ...
        storage4: R.Object = R.vm.alloc_storage(R.shape([802816]), R.prim_value(0), R.dtype("uint8"), R.str("global"))
        ...
        alloc16: R.Tensor((1, 64, 56, 56), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 64, 56, 56]), R.dtype("float32"))
        cls.conv2d1(alloc15, metadata["relax.expr.Constant"][15], alloc16)
        alloc17: R.Tensor((1, 64, 56, 56), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 56, 56]), R.dtype("float32"))
        ...
        lv15: R.Tuple(R.Tensor((1, 64, 56, 56), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")) = alloc17, alloc18, alloc19
        R.vm.kill_object(alloc18)
        R.vm.kill_object(alloc19)
        alloc20: R.Tensor((1, 64, 56, 56), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 64, 56, 56]), R.dtype("float32"))
        cls.fused_relu1(alloc17, alloc20)
        R.vm.kill_object(alloc17)
        alloc21: R.Tensor((1, 64, 56, 56), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 56, 56]), R.dtype("float32"))
        cls.conv2d1(alloc20, metadata["relax.expr.Constant"][20], alloc21)
        R.vm.kill_object(alloc20)
        alloc22: R.Tensor((1, 64, 56, 56), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 64, 56, 56]), R.dtype("float32"))
        ...
        lv19: R.Tuple(R.Tensor((1, 64, 56, 56), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")) = alloc22, alloc23, alloc24
        R.vm.kill_object(alloc23)
        R.vm.kill_object(alloc24)
        alloc25: R.Tensor((1, 64, 56, 56), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 56, 56]), R.dtype("float32"))
        cls.fused_add_relu1(alloc22, alloc15, alloc25)
        R.vm.kill_object(alloc15)
        R.vm.kill_object(alloc22)
        alloc26: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.conv2d2(alloc25, metadata["relax.expr.Constant"][25], alloc26)
        alloc27: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        ...
        lv24: R.Tuple(R.Tensor((1, 128, 28, 28), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc27, alloc28, alloc29
        R.vm.kill_object(alloc28)
        R.vm.kill_object(alloc29)
        alloc30: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.fused_relu2(alloc27, alloc30)
        R.vm.kill_object(alloc27)
        alloc31: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.conv2d3(alloc30, metadata["relax.expr.Constant"][30], alloc31)
        R.vm.kill_object(alloc30)
        alloc32: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        ...
        lv28: R.Tuple(R.Tensor((1, 128, 28, 28), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc32, alloc33, alloc34
        R.vm.kill_object(alloc33)
        R.vm.kill_object(alloc34)
        alloc35: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.conv2d4(alloc25, metadata["relax.expr.Constant"][35], alloc35)
        R.vm.kill_object(alloc25)
        alloc36: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        ...
        lv31: R.Tuple(R.Tensor((1, 128, 28, 28), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc36, alloc37, alloc38
        R.vm.kill_object(alloc37)
        R.vm.kill_object(alloc38)
        alloc39: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.fused_add1_relu2(alloc32, alloc36, alloc39)
        R.vm.kill_object(alloc32)
        R.vm.kill_object(alloc36)
        alloc40: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.conv2d3(alloc39, metadata["relax.expr.Constant"][40], alloc40)
        alloc41: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        ...
        lv36: R.Tuple(R.Tensor((1, 128, 28, 28), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc41, alloc42, alloc43
        R.vm.kill_object(alloc42)
        R.vm.kill_object(alloc43)
        alloc44: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.fused_relu2(alloc41, alloc44)
        R.vm.kill_object(alloc41)
        alloc45: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.conv2d3(alloc44, metadata["relax.expr.Constant"][45], alloc45)
        R.vm.kill_object(alloc44)
        alloc46: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        ...
        lv40: R.Tuple(R.Tensor((1, 128, 28, 28), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc46, alloc47, alloc48
        R.vm.kill_object(alloc47)
        R.vm.kill_object(alloc48)
        alloc49: R.Tensor((1, 128, 28, 28), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 28, 28]), R.dtype("float32"))
        cls.fused_add1_relu2(alloc46, alloc39, alloc49)
        R.vm.kill_object(alloc39)
        R.vm.kill_object(alloc46)
        alloc50: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        cls.conv2d5(alloc49, metadata["relax.expr.Constant"][50], alloc50)
        alloc51: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        ...
        lv45: R.Tuple(R.Tensor((1, 256, 14, 14), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc51, alloc52, alloc53
        R.vm.kill_object(alloc52)
        R.vm.kill_object(alloc53)
        alloc54: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        cls.fused_relu3(alloc51, alloc54)
        R.vm.kill_object(alloc51)
        alloc55: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        cls.conv2d6(alloc54, metadata["relax.expr.Constant"][55], alloc55)
        R.vm.kill_object(alloc54)
        alloc56: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        ...
        lv49: R.Tuple(R.Tensor((1, 256, 14, 14), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc56, alloc57, alloc58
        R.vm.kill_object(alloc57)
        R.vm.kill_object(alloc58)
        alloc59: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        cls.conv2d7(alloc49, metadata["relax.expr.Constant"][60], alloc59)
        R.vm.kill_object(alloc49)
        alloc60: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        ...
        lv52: R.Tuple(R.Tensor((1, 256, 14, 14), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc60, alloc61, alloc62
        R.vm.kill_object(alloc61)
        R.vm.kill_object(alloc62)
        alloc63: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        R.vm.kill_object(storage)
        cls.fused_add2_relu3(alloc56, alloc60, alloc63)
        R.vm.kill_object(alloc56)
        R.vm.kill_object(alloc60)
        alloc64: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        cls.conv2d6(alloc63, metadata["relax.expr.Constant"][65], alloc64)
        alloc65: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        ...
        lv57: R.Tuple(R.Tensor((1, 256, 14, 14), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc65, alloc66, alloc67
        R.vm.kill_object(alloc66)
        R.vm.kill_object(alloc67)
        alloc68: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        cls.fused_relu3(alloc65, alloc68)
        R.vm.kill_object(alloc65)
        alloc69: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        cls.conv2d6(alloc68, metadata["relax.expr.Constant"][70], alloc69)
        R.vm.kill_object(alloc68)
        alloc70: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        ...
        lv61: R.Tuple(R.Tensor((1, 256, 14, 14), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc70, alloc71, alloc72
        R.vm.kill_object(alloc71)
        R.vm.kill_object(alloc72)
        alloc73: R.Tensor((1, 256, 14, 14), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 14, 14]), R.dtype("float32"))
        R.vm.kill_object(storage1)
        cls.fused_add2_relu3(alloc70, alloc63, alloc73)
        R.vm.kill_object(alloc63)
        R.vm.kill_object(alloc70)
        alloc74: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        ...
        alloc75: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        ...
        lv66: R.Tuple(R.Tensor((1, 512, 7, 7), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc75, alloc76, alloc77
        R.vm.kill_object(alloc76)
        R.vm.kill_object(alloc77)
        alloc78: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        cls.fused_relu4(alloc75, alloc78)
        R.vm.kill_object(alloc75)
        alloc79: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        cls.conv2d9(alloc78, metadata["relax.expr.Constant"][80], alloc79)
        R.vm.kill_object(alloc78)
        alloc80: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        ...
        lv70: R.Tuple(R.Tensor((1, 512, 7, 7), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc80, alloc81, alloc82
        R.vm.kill_object(alloc81)
        R.vm.kill_object(alloc82)
        alloc83: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        ...
        alloc84: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        ...
        lv73: R.Tuple(R.Tensor((1, 512, 7, 7), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc84, alloc85, alloc86
        R.vm.kill_object(alloc85)
        R.vm.kill_object(alloc86)
        alloc87: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        R.vm.kill_object(storage5)
        cls.fused_add3_relu4(alloc80, alloc84, alloc87)
        R.vm.kill_object(alloc80)
        R.vm.kill_object(alloc84)
        alloc88: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        cls.conv2d9(alloc87, metadata["relax.expr.Constant"][90], alloc88)
        alloc89: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        ...
        lv78: R.Tuple(R.Tensor((1, 512, 7, 7), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc89, alloc90, alloc91
        R.vm.kill_object(alloc90)
        R.vm.kill_object(alloc91)
        alloc92: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        cls.fused_relu4(alloc89, alloc92)
        R.vm.kill_object(alloc89)
        alloc93: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        cls.conv2d9(alloc92, metadata["relax.expr.Constant"][95], alloc93)
        R.vm.kill_object(alloc92)
        alloc94: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
        ...
        lv82: R.Tuple(R.Tensor((1, 512, 7, 7), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc94, alloc95, alloc96
        R.vm.kill_object(alloc95)
        R.vm.kill_object(alloc96)
        alloc97: R.Tensor((1, 512, 7, 7), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 7, 7]), R.dtype("float32"))
