...
class Module:
    ...
    def adaptive_avg_pool2d(lv224: T.Buffer((T.int64(1), T.int64(2048), T.int64(32), T.int64(32)), "float32"), adaptive_pool_avg: T.Buffer((T.int64(1), T.int64(2048), T.int64(1), T.int64(1)), "float32")):
        ...
        adaptive_pool_sum_rf_local = T.alloc_buffer((T.int64(1024), T.int64(1), T.int64(2048), T.int64(1), T.int64(1)), scope="local")
            ...
            for ax1_ax2_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x", annotations={"pragma_auto_unroll_max_step": 256, "pragma_unroll_explicit": 1}):
                ...
                for ax1_ax2_fused_0, u in T.grid(T.int64(1), 1):
                    with T.block("adaptive_pool_sum_rf_update"):
                        ...
                        T.reads(adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)], lv224[T.int64(0), v0, (vax1_ax2_fused_0 * T.int64(1024) + vax1_ax2_fused_1) // T.int64(32), (vax1_ax2_fused_0 * T.int64(1024) + vax1_ax2_fused_1) % T.int64(32)])
                        T.writes(adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)])
                        adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)] = adaptive_pool_sum_rf_local[vax1_ax2_fused_1, T.int64(0), v0, T.int64(0), T.int64(0)] + lv224[T.int64(0), v0, (vax1_ax2_fused_0 * T.int64(1024) + vax1_ax2_fused_1) // T.int64(32), (vax1_ax2_fused_0 * T.int64(1024) + vax1_ax2_fused_1) % T.int64(32)]
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv187_red[v0] * T.float32(0.0009765625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(32), T.int64(32)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv187[T.int64(0), v0, v1, v2] - lv187_red[v0] * T.float32(0.0009765625)) * (lv187[T.int64(0), v0, v1, v2] - lv187_red[v0] * T.float32(0.0009765625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
    ...
    def batch_norm11(lv191: T.Buffer((T.int64(1), T.int64(2048), T.int64(32), T.int64(32)), "float32"), B: T.Buffer((T.int64(2048),), "float32"), C: T.Buffer((T.int64(2048),), "float32"), D: T.Buffer((T.int64(2048),), "float32"), E: T.Buffer((T.int64(2048),), "float32"), T_add: T.Buffer((T.int64(1), T.int64(2048), T.int64(32), T.int64(32)), "float32"), T_add_1: T.Buffer((T.int64(2048),), "float32"), T_add_2: T.Buffer((T.int64(2048),), "float32")):
        ...
        for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(2048), thread="blockIdx.x"):
            for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_1"):
                    v0 = T.axis.spatial(T.int64(2048), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) // T.int64(1024))
                    v1 = T.axis.spatial(T.int64(32), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(1024) // T.int64(32))
                    v2 = T.axis.spatial(T.int64(32), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(32))
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(2), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv191_red[v0] * T.float32(0.0009765625))
        for ax0_fused_0 in T.thread_binding(T.int64(2), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(2048), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(32), T.int64(32)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv191[T.int64(0), v0, v1, v2] - lv191_red[v0] * T.float32(0.0009765625)) * (lv191[T.int64(0), v0, v1, v2] - lv191_red[v0] * T.float32(0.0009765625))
        for ax0_fused_0 in T.thread_binding(T.int64(2), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(2048), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
    ...
    def batch_norm2(lv13: T.Buffer((T.int64(1), T.int64(256), T.int64(256), T.int64(256)), "float32"), B: T.Buffer((T.int64(256),), "float32"), C: T.Buffer((T.int64(256),), "float32"), D: T.Buffer((T.int64(256),), "float32"), E: T.Buffer((T.int64(256),), "float32"), T_add: T.Buffer((T.int64(1), T.int64(256), T.int64(256), T.int64(256)), "float32"), T_add_1: T.Buffer((T.int64(256),), "float32"), T_add_2: T.Buffer((T.int64(256),), "float32")):
        ...
        for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16384), thread="blockIdx.x"):
            for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_1"):
                    v0 = T.axis.spatial(T.int64(256), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) // T.int64(65536))
                    v1 = T.axis.spatial(T.int64(256), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(65536) // T.int64(256))
                    v2 = T.axis.spatial(T.int64(256), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(256))
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv13_red[v0] * T.float32(1.52587890625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(256), T.int64(256)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv13[T.int64(0), v0, v1, v2] - lv13_red[v0] * T.float32(1.52587890625e-05)) * (lv13[T.int64(0), v0, v1, v2] - lv13_red[v0] * T.float32(1.52587890625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
    ...
    def batch_norm3(lv47: T.Buffer((T.int64(1), T.int64(128), T.int64(256), T.int64(256)), "float32"), B: T.Buffer((T.int64(128),), "float32"), C: T.Buffer((T.int64(128),), "float32"), D: T.Buffer((T.int64(128),), "float32"), E: T.Buffer((T.int64(128),), "float32"), T_add: T.Buffer((T.int64(1), T.int64(128), T.int64(256), T.int64(256)), "float32"), T_add_1: T.Buffer((T.int64(128),), "float32"), T_add_2: T.Buffer((T.int64(128),), "float32")):
        ...
        for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(8192), thread="blockIdx.x"):
            for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_1"):
                    v0 = T.axis.spatial(T.int64(128), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) // T.int64(65536))
                    v1 = T.axis.spatial(T.int64(256), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(65536) // T.int64(256))
                    v2 = T.axis.spatial(T.int64(256), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(256))
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv47_red[v0] * T.float32(1.52587890625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(128), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(256), T.int64(256)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv47[T.int64(0), v0, v1, v2] - lv47_red[v0] * T.float32(1.52587890625e-05)) * (lv47[T.int64(0), v0, v1, v2] - lv47_red[v0] * T.float32(1.52587890625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(128), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv51_red[v0] * T.float32(6.103515625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(128), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(128), T.int64(128)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv51[T.int64(0), v0, v1, v2] - lv51_red[v0] * T.float32(6.103515625e-05)) * (lv51[T.int64(0), v0, v1, v2] - lv51_red[v0] * T.float32(6.103515625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(128), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
    ...
    def batch_norm5(lv55: T.Buffer((T.int64(1), T.int64(512), T.int64(128), T.int64(128)), "float32"), B: T.Buffer((T.int64(512),), "float32"), C: T.Buffer((T.int64(512),), "float32"), D: T.Buffer((T.int64(512),), "float32"), E: T.Buffer((T.int64(512),), "float32"), T_add: T.Buffer((T.int64(1), T.int64(512), T.int64(128), T.int64(128)), "float32"), T_add_1: T.Buffer((T.int64(512),), "float32"), T_add_2: T.Buffer((T.int64(512),), "float32")):
        ...
        for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(8192), thread="blockIdx.x"):
            for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_1"):
                    v0 = T.axis.spatial(T.int64(512), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) // T.int64(16384))
                    v1 = T.axis.spatial(T.int64(128), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(16384) // T.int64(128))
                    v2 = T.axis.spatial(T.int64(128), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(128))
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv55_red[v0] * T.float32(6.103515625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(128), T.int64(128)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv55[T.int64(0), v0, v1, v2] - lv55_red[v0] * T.float32(6.103515625e-05)) * (lv55[T.int64(0), v0, v1, v2] - lv55_red[v0] * T.float32(6.103515625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv102_red[v0] * T.float32(6.103515625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(128), T.int64(128)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv102[T.int64(0), v0, v1, v2] - lv102_red[v0] * T.float32(6.103515625e-05)) * (lv102[T.int64(0), v0, v1, v2] - lv102_red[v0] * T.float32(6.103515625e-05))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv106_red[v0] * T.float32(0.000244140625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(64), T.int64(64)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv106[T.int64(0), v0, v1, v2] - lv106_red[v0] * T.float32(0.000244140625)) * (lv106[T.int64(0), v0, v1, v2] - lv106_red[v0] * T.float32(0.000244140625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(256), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
    ...
    def batch_norm8(lv110: T.Buffer((T.int64(1), T.int64(1024), T.int64(64), T.int64(64)), "float32"), B: T.Buffer((T.int64(1024),), "float32"), C: T.Buffer((T.int64(1024),), "float32"), D: T.Buffer((T.int64(1024),), "float32"), E: T.Buffer((T.int64(1024),), "float32"), T_add: T.Buffer((T.int64(1), T.int64(1024), T.int64(64), T.int64(64)), "float32"), T_add_1: T.Buffer((T.int64(1024),), "float32"), T_add_2: T.Buffer((T.int64(1024),), "float32")):
        ...
        for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(4096), thread="blockIdx.x"):
            for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_1"):
                    v0 = T.axis.spatial(T.int64(1024), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) // T.int64(4096))
                    v1 = T.axis.spatial(T.int64(64), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(4096) // T.int64(64))
                    v2 = T.axis.spatial(T.int64(64), (ax0_ax1_ax2_fused_0 * T.int64(1024) + ax0_ax1_ax2_fused_1) % T.int64(64))
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv110_red[v0] * T.float32(0.000244140625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(1024), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(64), T.int64(64)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv110[T.int64(0), v0, v1, v2] - lv110_red[v0] * T.float32(0.000244140625)) * (lv110[T.int64(0), v0, v1, v2] - lv110_red[v0] * T.float32(0.000244140625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(1024), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
        ...
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_2"):
                    ...
                    T.writes(T_add_1[v0])
                    T_add_1[v0] = T.float32(0.90000000000000002) * D[v0] + T.float32(0.10000000000000001) * (lv183_red[v0] * T.float32(0.000244140625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_multiply_red_init"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
                ...
                for ax1, ax2 in T.grid(T.int64(64), T.int64(64)):
                    with T.block("T_multiply_red_update"):
                        ...
                        T.writes(T_multiply_red[v0])
                        T_multiply_red[v0] = T_multiply_red[v0] + (lv183[T.int64(0), v0, v1, v2] - lv183_red[v0] * T.float32(0.000244140625)) * (lv183[T.int64(0), v0, v1, v2] - lv183_red[v0] * T.float32(0.000244140625))
        for ax0_fused_0 in T.thread_binding(T.int64(1), thread="blockIdx.x"):
            for ax0_fused_1 in T.thread_binding(T.int64(1024), thread="threadIdx.x"):
                with T.block("T_add_3"):
                    v0 = T.axis.spatial(T.int64(512), ax0_fused_0 * T.int64(1024) + ax0_fused_1)
    ...
    def conv2d1(lv4: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32"), B: T.Buffer((T.int64(64), T.int64(64), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32")):
        ...
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(65536), T.int64(64)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv4[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv4[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv66[T.int64(0), v2 // T.int64(9), v1 // T.int64(128) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(128) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(128) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(128) + v2 // T.int64(3) % T.int64(3) < T.int64(129) and T.int64(1) <= v1 % T.int64(128) + v2 % T.int64(3) and v1 % T.int64(128) + v2 % T.int64(3) < T.int64(129), lv66[T.int64(0), v2 // T.int64(9), v1 // T.int64(128) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(128) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d11(lv101: T.Buffer((T.int64(1), T.int64(512), T.int64(128), T.int64(128)), "float32"), B: T.Buffer((T.int64(256), T.int64(512), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(256), T.int64(128), T.int64(128)), "float32")):
        ...
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(16384), T.int64(512)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv101[T.int64(0), v2, v1 // T.int64(128), v1 % T.int64(128)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv101[T.int64(0), v2, v1 // T.int64(128), v1 % T.int64(128)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv105[T.int64(0), v2 // T.int64(9), v1 // T.int64(64) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(64) * T.int64(2) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(64) * T.int64(2) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(64) * T.int64(2) + v2 // T.int64(3) % T.int64(3) < T.int64(129) and T.int64(1) <= v1 % T.int64(64) * T.int64(2) + v2 % T.int64(3) and v1 % T.int64(64) * T.int64(2) + v2 % T.int64(3) < T.int64(129), lv105[T.int64(0), v2 // T.int64(9), v1 // T.int64(64) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(64) * T.int64(2) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d13(lv109: T.Buffer((T.int64(1), T.int64(256), T.int64(64), T.int64(64)), "float32"), B: T.Buffer((T.int64(1024), T.int64(256), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(1024), T.int64(64), T.int64(64)), "float32")):
        T.func_attr({"op_pattern": 4, "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(4096), T.int64(1024)), scope="local")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv109[T.int64(0), v2, v1 // T.int64(64), v1 % T.int64(64)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv109[T.int64(0), v2, v1 // T.int64(64), v1 % T.int64(64)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(4096), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(512), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv101[T.int64(0), v2, v1 // T.int64(64) * T.int64(2), v1 % T.int64(64) * T.int64(2)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv101[T.int64(0), v2, v1 // T.int64(64) * T.int64(2), v1 % T.int64(64) * T.int64(2)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d15(lv117: T.Buffer((T.int64(1), T.int64(1024), T.int64(64), T.int64(64)), "float32"), B: T.Buffer((T.int64(256), T.int64(1024), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(256), T.int64(64), T.int64(64)), "float32")):
        ...
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(4096), T.int64(256)), scope="local")
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(4096), T.int64(1024)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv117[T.int64(0), v2, v1 // T.int64(64), v1 % T.int64(64)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv117[T.int64(0), v2, v1 // T.int64(64), v1 % T.int64(64)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(4096), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(2304), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv121[T.int64(0), v2 // T.int64(9), v1 // T.int64(64) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(64) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(64) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(64) + v2 // T.int64(3) % T.int64(3) < T.int64(65) and T.int64(1) <= v1 % T.int64(64) + v2 % T.int64(3) and v1 % T.int64(64) + v2 % T.int64(3) < T.int64(65), lv121[T.int64(0), v2 // T.int64(9), v1 // T.int64(64) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(64) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(4096), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(1024), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv182[T.int64(0), v2, v1 // T.int64(64), v1 % T.int64(64)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv182[T.int64(0), v2, v1 // T.int64(64), v1 % T.int64(64)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv186[T.int64(0), v2 // T.int64(9), v1 // T.int64(32) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(32) * T.int64(2) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(32) * T.int64(2) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(32) * T.int64(2) + v2 // T.int64(3) % T.int64(3) < T.int64(65) and T.int64(1) <= v1 % T.int64(32) * T.int64(2) + v2 % T.int64(3) and v1 % T.int64(32) * T.int64(2) + v2 % T.int64(3) < T.int64(65), lv186[T.int64(0), v2 // T.int64(9), v1 // T.int64(32) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(32) * T.int64(2) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d19(lv190: T.Buffer((T.int64(1), T.int64(512), T.int64(32), T.int64(32)), "float32"), B: T.Buffer((T.int64(2048), T.int64(512), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(2048), T.int64(32), T.int64(32)), "float32")):
        T.func_attr({"op_pattern": 4, "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(1024), T.int64(2048)), scope="local")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(1024), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(512), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv190[T.int64(0), v2, v1 // T.int64(32), v1 % T.int64(32)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv190[T.int64(0), v2, v1 // T.int64(32), v1 % T.int64(32)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv8[T.int64(0), v2 // T.int64(9), v1 // T.int64(256) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(256) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(256) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(256) + v2 // T.int64(3) % T.int64(3) < T.int64(257) and T.int64(1) <= v1 % T.int64(256) + v2 % T.int64(3) and v1 % T.int64(256) + v2 % T.int64(3) < T.int64(257), lv8[T.int64(0), v2 // T.int64(9), v1 // T.int64(256) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(256) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(1024), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(1024), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv182[T.int64(0), v2, v1 // T.int64(32) * T.int64(2), v1 % T.int64(32) * T.int64(2)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv182[T.int64(0), v2, v1 // T.int64(32) * T.int64(2), v1 % T.int64(32) * T.int64(2)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d21(lv198: T.Buffer((T.int64(1), T.int64(2048), T.int64(32), T.int64(32)), "float32"), B: T.Buffer((T.int64(512), T.int64(2048), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(512), T.int64(32), T.int64(32)), "float32")):
        ...
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(1024), T.int64(512)), scope="local")
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(1024), T.int64(2048)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv198[T.int64(0), v2, v1 // T.int64(32), v1 % T.int64(32)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv198[T.int64(0), v2, v1 // T.int64(32), v1 % T.int64(32)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(1024), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(4608), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv202[T.int64(0), v2 // T.int64(9), v1 // T.int64(32) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(32) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(32) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(32) + v2 // T.int64(3) % T.int64(3) < T.int64(33) and T.int64(1) <= v1 % T.int64(32) + v2 % T.int64(3) and v1 % T.int64(32) + v2 % T.int64(3) < T.int64(33), lv202[T.int64(0), v2 // T.int64(9), v1 // T.int64(32) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(32) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d3(lv12: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32"), B: T.Buffer((T.int64(256), T.int64(64), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(256), T.int64(256), T.int64(256)), "float32")):
        T.func_attr({"op_pattern": 4, "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(65536), T.int64(256)), scope="local")
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(65536), T.int64(64)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(65536), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(64), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv12[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv12[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d4(lv20: T.Buffer((T.int64(1), T.int64(256), T.int64(256), T.int64(256)), "float32"), B: T.Buffer((T.int64(64), T.int64(256), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(64), T.int64(256), T.int64(256)), "float32")):
        ...
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(65536), T.int64(64)), scope="local")
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(65536), T.int64(256)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(65536), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(256), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv20[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv20[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d5(lv46: T.Buffer((T.int64(1), T.int64(256), T.int64(256), T.int64(256)), "float32"), B: T.Buffer((T.int64(128), T.int64(256), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(128), T.int64(256), T.int64(256)), "float32")):
        T.func_attr({"op_pattern": 4, "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(65536), T.int64(128)), scope="local")
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(65536), T.int64(256)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(65536), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(256), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv46[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv46[T.int64(0), v2, v1 // T.int64(256), v1 % T.int64(256)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(16384), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(1152), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv50[T.int64(0), v2 // T.int64(9), v1 // T.int64(128) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(128) * T.int64(2) + v2 % T.int64(3) - T.int64(1)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = T.if_then_else(T.int64(1) <= v1 // T.int64(128) * T.int64(2) + v2 // T.int64(3) % T.int64(3) and v1 // T.int64(128) * T.int64(2) + v2 // T.int64(3) % T.int64(3) < T.int64(257) and T.int64(1) <= v1 % T.int64(128) * T.int64(2) + v2 % T.int64(3) and v1 % T.int64(128) * T.int64(2) + v2 % T.int64(3) < T.int64(257), lv50[T.int64(0), v2 // T.int64(9), v1 // T.int64(128) * T.int64(2) + v2 // T.int64(3) % T.int64(3) - T.int64(1), v1 % T.int64(128) * T.int64(2) + v2 % T.int64(3) - T.int64(1)], T.float32(0.0))
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def conv2d7(lv54: T.Buffer((T.int64(1), T.int64(128), T.int64(128), T.int64(128)), "float32"), B: T.Buffer((T.int64(512), T.int64(128), T.int64(1), T.int64(1)), "float32"), conv2d_nchw: T.Buffer((T.int64(1), T.int64(512), T.int64(128), T.int64(128)), "float32")):
        T.func_attr({"op_pattern": 4, "tir.is_scheduled": True, "tir.noalias": True})
        # with T.block("root"):
        conv2d_nchw_reindex_local = T.alloc_buffer((T.int64(1), T.int64(16384), T.int64(512)), scope="local")
        pad_temp_reindex_shared = T.alloc_buffer((T.int64(1), T.int64(16384), T.int64(128)), scope="shared")
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        T.reads(lv54[T.int64(0), v2, v1 // T.int64(128), v1 % T.int64(128)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv54[T.int64(0), v2, v1 // T.int64(128), v1 % T.int64(128)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(16384), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(256), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv46[T.int64(0), v2, v1 // T.int64(128) * T.int64(2), v1 % T.int64(128) * T.int64(2)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv46[T.int64(0), v2, v1 // T.int64(128) * T.int64(2), v1 % T.int64(128) * T.int64(2)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                            ...
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(2)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
                                                    with T.block("pad_temp_reindex_shared"):
                                                        ...
                                                        v1 = T.axis.spatial(T.int64(16384), ax1_0 * T.int64(32) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) // T.int64(16))
                                                        v2 = T.axis.spatial(T.int64(512), ax3_0 * T.int64(16) + (ax0_ax1_ax2_fused_0 * T.int64(32) + ax0_ax1_ax2_fused_1 * T.int64(4) + ax0_ax1_ax2_fused_2 * T.int64(2) + ax0_ax1_ax2_fused_3) % T.int64(16))
                                                        T.reads(lv62[T.int64(0), v2, v1 // T.int64(128), v1 % T.int64(128)])
                                                        T.writes(pad_temp_reindex_shared[v0, v1, v2])
                                                        T.block_attr({"buffer_dim_align": [[0, 1, 8, 2]]})
                                                        pad_temp_reindex_shared[v0, v1, v2] = lv62[T.int64(0), v2, v1 // T.int64(128), v1 % T.int64(128)]
                                    for ax0_ax1_ax2_fused_0 in T.thread_binding(T.int64(16), thread="threadIdx.y"):
                                        for ax0_ax1_ax2_fused_1 in T.thread_binding(T.int64(8), thread="threadIdx.x"):
                                            for ax0_ax1_ax2_fused_2 in range(T.int64(4)):
                                                for ax0_ax1_ax2_fused_3 in T.vectorized(T.int64(2)):
    ...
    def main(inp_0: R.Tensor((1, 3, 1024, 1024), dtype="float32")) -> R.Tensor((1, 1000), dtype="float32"):
        ...
        storage4: R.Object = R.vm.alloc_storage(R.shape([67108864]), R.prim_value(0), R.dtype("uint8"), R.str("global"))
        ...
        alloc16: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        cls.conv2d3(alloc15, metadata["relax.expr.Constant"][15], alloc16)
        R.vm.kill_object(alloc15)
        alloc17: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        ...
        lv14: R.Tuple(R.Tensor((1, 256, 256, 256), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc17, alloc18, alloc19
        R.vm.kill_object(alloc18)
        R.vm.kill_object(alloc19)
        alloc20: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        cls.conv2d3(alloc5, metadata["relax.expr.Constant"][20], alloc20)
        R.vm.kill_object(alloc5)
        alloc21: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        ...
        lv17: R.Tuple(R.Tensor((1, 256, 256, 256), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc21, alloc22, alloc23
        R.vm.kill_object(alloc22)
        R.vm.kill_object(alloc23)
        alloc24: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        cls.fused_add_relu2(alloc17, alloc21, alloc24)
        R.vm.kill_object(alloc17)
        R.vm.kill_object(alloc21)
        alloc25: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.conv2d4(alloc24, metadata["relax.expr.Constant"][25], alloc25)
        alloc26: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        ...
        lv22: R.Tuple(R.Tensor((1, 64, 256, 256), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")) = alloc26, alloc27, alloc28
        R.vm.kill_object(alloc27)
        R.vm.kill_object(alloc28)
        alloc29: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.fused_relu1(alloc26, alloc29)
        R.vm.kill_object(alloc26)
        alloc30: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.conv2d2(alloc29, metadata["relax.expr.Constant"][30], alloc30)
        R.vm.kill_object(alloc29)
        alloc31: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        ...
        lv26: R.Tuple(R.Tensor((1, 64, 256, 256), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")) = alloc31, alloc32, alloc33
        R.vm.kill_object(alloc32)
        R.vm.kill_object(alloc33)
        alloc34: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.fused_relu1(alloc31, alloc34)
        R.vm.kill_object(alloc31)
        alloc35: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        cls.conv2d3(alloc34, metadata["relax.expr.Constant"][35], alloc35)
        R.vm.kill_object(alloc34)
        alloc36: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        ...
        lv30: R.Tuple(R.Tensor((1, 256, 256, 256), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc36, alloc37, alloc38
        R.vm.kill_object(alloc37)
        R.vm.kill_object(alloc38)
        alloc39: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        cls.fused_add_relu2(alloc36, alloc24, alloc39)
        R.vm.kill_object(alloc24)
        R.vm.kill_object(alloc36)
        alloc40: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.conv2d4(alloc39, metadata["relax.expr.Constant"][40], alloc40)
        alloc41: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        ...
        lv35: R.Tuple(R.Tensor((1, 64, 256, 256), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")) = alloc41, alloc42, alloc43
        R.vm.kill_object(alloc42)
        R.vm.kill_object(alloc43)
        alloc44: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.fused_relu1(alloc41, alloc44)
        R.vm.kill_object(alloc41)
        alloc45: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.conv2d2(alloc44, metadata["relax.expr.Constant"][45], alloc45)
        R.vm.kill_object(alloc44)
        alloc46: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        ...
        lv39: R.Tuple(R.Tensor((1, 64, 256, 256), dtype="float32"), R.Tensor((64,), dtype="float32"), R.Tensor((64,), dtype="float32")) = alloc46, alloc47, alloc48
        R.vm.kill_object(alloc47)
        R.vm.kill_object(alloc48)
        alloc49: R.Tensor((1, 64, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 64, 256, 256]), R.dtype("float32"))
        cls.fused_relu1(alloc46, alloc49)
        R.vm.kill_object(alloc46)
        alloc50: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        cls.conv2d3(alloc49, metadata["relax.expr.Constant"][50], alloc50)
        R.vm.kill_object(alloc49)
        alloc51: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        ...
        lv43: R.Tuple(R.Tensor((1, 256, 256, 256), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc51, alloc52, alloc53
        R.vm.kill_object(alloc52)
        R.vm.kill_object(alloc53)
        alloc54: R.Tensor((1, 256, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 256, 256]), R.dtype("float32"))
        cls.fused_add_relu2(alloc51, alloc39, alloc54)
        R.vm.kill_object(alloc39)
        R.vm.kill_object(alloc51)
        alloc55: R.Tensor((1, 128, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 256, 256]), R.dtype("float32"))
        cls.conv2d5(alloc54, metadata["relax.expr.Constant"][55], alloc55)
        alloc56: R.Tensor((1, 128, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 256, 256]), R.dtype("float32"))
        ...
        lv48: R.Tuple(R.Tensor((1, 128, 256, 256), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc56, alloc57, alloc58
        R.vm.kill_object(alloc57)
        R.vm.kill_object(alloc58)
        alloc59: R.Tensor((1, 128, 256, 256), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 256, 256]), R.dtype("float32"))
        cls.fused_relu3(alloc56, alloc59)
        R.vm.kill_object(alloc56)
        alloc60: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.conv2d6(alloc59, metadata["relax.expr.Constant"][60], alloc60)
        R.vm.kill_object(alloc59)
        alloc61: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        ...
        lv52: R.Tuple(R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc61, alloc62, alloc63
        R.vm.kill_object(alloc62)
        R.vm.kill_object(alloc63)
        alloc64: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.fused_relu4(alloc61, alloc64)
        R.vm.kill_object(alloc61)
        alloc65: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.conv2d7(alloc64, metadata["relax.expr.Constant"][65], alloc65)
        R.vm.kill_object(alloc64)
        alloc66: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        ...
        lv56: R.Tuple(R.Tensor((1, 512, 128, 128), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc66, alloc67, alloc68
        R.vm.kill_object(alloc67)
        R.vm.kill_object(alloc68)
        alloc69: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.conv2d8(alloc54, metadata["relax.expr.Constant"][70], alloc69)
        R.vm.kill_object(alloc54)
        alloc70: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        ...
        lv59: R.Tuple(R.Tensor((1, 512, 128, 128), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc70, alloc71, alloc72
        R.vm.kill_object(alloc71)
        R.vm.kill_object(alloc72)
        alloc73: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.fused_add1_relu5(alloc66, alloc70, alloc73)
        R.vm.kill_object(alloc66)
        R.vm.kill_object(alloc70)
        alloc74: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.conv2d9(alloc73, metadata["relax.expr.Constant"][75], alloc74)
        alloc75: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        ...
        lv64: R.Tuple(R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc75, alloc76, alloc77
        R.vm.kill_object(alloc76)
        R.vm.kill_object(alloc77)
        alloc78: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.fused_relu4(alloc75, alloc78)
        R.vm.kill_object(alloc75)
        alloc79: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.conv2d10(alloc78, metadata["relax.expr.Constant"][80], alloc79)
        R.vm.kill_object(alloc78)
        alloc80: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        ...
        lv68: R.Tuple(R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc80, alloc81, alloc82
        R.vm.kill_object(alloc81)
        R.vm.kill_object(alloc82)
        alloc83: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.fused_relu4(alloc80, alloc83)
        R.vm.kill_object(alloc80)
        alloc84: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.conv2d7(alloc83, metadata["relax.expr.Constant"][85], alloc84)
        R.vm.kill_object(alloc83)
        alloc85: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        ...
        lv72: R.Tuple(R.Tensor((1, 512, 128, 128), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc85, alloc86, alloc87
        R.vm.kill_object(alloc86)
        R.vm.kill_object(alloc87)
        alloc88: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.fused_add1_relu5(alloc85, alloc73, alloc88)
        R.vm.kill_object(alloc73)
        R.vm.kill_object(alloc85)
        alloc89: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.conv2d9(alloc88, metadata["relax.expr.Constant"][90], alloc89)
        alloc90: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        ...
        lv77: R.Tuple(R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc90, alloc91, alloc92
        R.vm.kill_object(alloc91)
        R.vm.kill_object(alloc92)
        alloc93: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.fused_relu4(alloc90, alloc93)
        R.vm.kill_object(alloc90)
        alloc94: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.conv2d10(alloc93, metadata["relax.expr.Constant"][95], alloc94)
        R.vm.kill_object(alloc93)
        alloc95: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        ...
        lv81: R.Tuple(R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc95, alloc96, alloc97
        R.vm.kill_object(alloc96)
        R.vm.kill_object(alloc97)
        alloc98: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.fused_relu4(alloc95, alloc98)
        R.vm.kill_object(alloc95)
        alloc99: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.conv2d7(alloc98, metadata["relax.expr.Constant"][100], alloc99)
        R.vm.kill_object(alloc98)
        alloc100: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        ...
        lv85: R.Tuple(R.Tensor((1, 512, 128, 128), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc100, alloc101, alloc102
        R.vm.kill_object(alloc101)
        R.vm.kill_object(alloc102)
        alloc103: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.fused_add1_relu5(alloc100, alloc88, alloc103)
        R.vm.kill_object(alloc88)
        R.vm.kill_object(alloc100)
        alloc104: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.conv2d9(alloc103, metadata["relax.expr.Constant"][105], alloc104)
        alloc105: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        ...
        lv90: R.Tuple(R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc105, alloc106, alloc107
        R.vm.kill_object(alloc106)
        R.vm.kill_object(alloc107)
        alloc108: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.fused_relu4(alloc105, alloc108)
        R.vm.kill_object(alloc105)
        alloc109: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.conv2d10(alloc108, metadata["relax.expr.Constant"][110], alloc109)
        R.vm.kill_object(alloc108)
        alloc110: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        ...
        lv94: R.Tuple(R.Tensor((1, 128, 128, 128), dtype="float32"), R.Tensor((128,), dtype="float32"), R.Tensor((128,), dtype="float32")) = alloc110, alloc111, alloc112
        R.vm.kill_object(alloc111)
        R.vm.kill_object(alloc112)
        alloc113: R.Tensor((1, 128, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 128, 128, 128]), R.dtype("float32"))
        cls.fused_relu4(alloc110, alloc113)
        R.vm.kill_object(alloc110)
        alloc114: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.conv2d7(alloc113, metadata["relax.expr.Constant"][115], alloc114)
        R.vm.kill_object(alloc113)
        alloc115: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        ...
        lv98: R.Tuple(R.Tensor((1, 512, 128, 128), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc115, alloc116, alloc117
        R.vm.kill_object(alloc116)
        R.vm.kill_object(alloc117)
        alloc118: R.Tensor((1, 512, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 512, 128, 128]), R.dtype("float32"))
        cls.fused_add1_relu5(alloc115, alloc103, alloc118)
        R.vm.kill_object(alloc103)
        R.vm.kill_object(alloc115)
        alloc119: R.Tensor((1, 256, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 128, 128]), R.dtype("float32"))
        cls.conv2d11(alloc118, metadata["relax.expr.Constant"][120], alloc119)
        alloc120: R.Tensor((1, 256, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 128, 128]), R.dtype("float32"))
        ...
        lv103: R.Tuple(R.Tensor((1, 256, 128, 128), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc120, alloc121, alloc122
        R.vm.kill_object(alloc121)
        R.vm.kill_object(alloc122)
        alloc123: R.Tensor((1, 256, 128, 128), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 128, 128]), R.dtype("float32"))
        cls.fused_relu6(alloc120, alloc123)
        R.vm.kill_object(alloc120)
        alloc124: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d12(alloc123, metadata["relax.expr.Constant"][125], alloc124)
        R.vm.kill_object(alloc123)
        alloc125: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv107: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc125, alloc126, alloc127
        R.vm.kill_object(alloc126)
        R.vm.kill_object(alloc127)
        alloc128: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc125, alloc128)
        R.vm.kill_object(alloc125)
        alloc129: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.conv2d13(alloc128, metadata["relax.expr.Constant"][130], alloc129)
        R.vm.kill_object(alloc128)
        alloc130: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        ...
        lv111: R.Tuple(R.Tensor((1, 1024, 64, 64), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")) = alloc130, alloc131, alloc132
        R.vm.kill_object(alloc131)
        R.vm.kill_object(alloc132)
        alloc133: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.conv2d14(alloc118, metadata["relax.expr.Constant"][135], alloc133)
        R.vm.kill_object(alloc118)
        alloc134: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        ...
        lv114: R.Tuple(R.Tensor((1, 1024, 64, 64), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")) = alloc134, alloc135, alloc136
        R.vm.kill_object(alloc135)
        R.vm.kill_object(alloc136)
        alloc137: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.fused_add2_relu8(alloc130, alloc134, alloc137)
        R.vm.kill_object(alloc130)
        R.vm.kill_object(alloc134)
        alloc138: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d15(alloc137, metadata["relax.expr.Constant"][140], alloc138)
        alloc139: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv119: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc139, alloc140, alloc141
        R.vm.kill_object(alloc140)
        R.vm.kill_object(alloc141)
        alloc142: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc139, alloc142)
        R.vm.kill_object(alloc139)
        alloc143: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d16(alloc142, metadata["relax.expr.Constant"][145], alloc143)
        R.vm.kill_object(alloc142)
        alloc144: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv123: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc144, alloc145, alloc146
        R.vm.kill_object(alloc145)
        R.vm.kill_object(alloc146)
        alloc147: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc144, alloc147)
        R.vm.kill_object(alloc144)
        alloc148: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.conv2d13(alloc147, metadata["relax.expr.Constant"][150], alloc148)
        R.vm.kill_object(alloc147)
        alloc149: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        ...
        lv127: R.Tuple(R.Tensor((1, 1024, 64, 64), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")) = alloc149, alloc150, alloc151
        R.vm.kill_object(alloc150)
        R.vm.kill_object(alloc151)
        alloc152: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.fused_add2_relu8(alloc149, alloc137, alloc152)
        R.vm.kill_object(alloc137)
        R.vm.kill_object(alloc149)
        alloc153: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d15(alloc152, metadata["relax.expr.Constant"][155], alloc153)
        alloc154: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv132: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc154, alloc155, alloc156
        R.vm.kill_object(alloc155)
        R.vm.kill_object(alloc156)
        alloc157: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc154, alloc157)
        R.vm.kill_object(alloc154)
        alloc158: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d16(alloc157, metadata["relax.expr.Constant"][160], alloc158)
        R.vm.kill_object(alloc157)
        alloc159: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv136: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc159, alloc160, alloc161
        R.vm.kill_object(alloc160)
        R.vm.kill_object(alloc161)
        alloc162: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc159, alloc162)
        R.vm.kill_object(alloc159)
        alloc163: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.conv2d13(alloc162, metadata["relax.expr.Constant"][165], alloc163)
        R.vm.kill_object(alloc162)
        alloc164: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        ...
        lv140: R.Tuple(R.Tensor((1, 1024, 64, 64), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")) = alloc164, alloc165, alloc166
        R.vm.kill_object(alloc165)
        R.vm.kill_object(alloc166)
        alloc167: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.fused_add2_relu8(alloc164, alloc152, alloc167)
        R.vm.kill_object(alloc152)
        R.vm.kill_object(alloc164)
        alloc168: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d15(alloc167, metadata["relax.expr.Constant"][170], alloc168)
        alloc169: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv145: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc169, alloc170, alloc171
        R.vm.kill_object(alloc170)
        R.vm.kill_object(alloc171)
        alloc172: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc169, alloc172)
        R.vm.kill_object(alloc169)
        alloc173: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d16(alloc172, metadata["relax.expr.Constant"][175], alloc173)
        R.vm.kill_object(alloc172)
        alloc174: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv149: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc174, alloc175, alloc176
        R.vm.kill_object(alloc175)
        R.vm.kill_object(alloc176)
        alloc177: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc174, alloc177)
        R.vm.kill_object(alloc174)
        alloc178: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.conv2d13(alloc177, metadata["relax.expr.Constant"][180], alloc178)
        R.vm.kill_object(alloc177)
        alloc179: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        ...
        lv153: R.Tuple(R.Tensor((1, 1024, 64, 64), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")) = alloc179, alloc180, alloc181
        R.vm.kill_object(alloc180)
        R.vm.kill_object(alloc181)
        alloc182: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.fused_add2_relu8(alloc179, alloc167, alloc182)
        R.vm.kill_object(alloc167)
        R.vm.kill_object(alloc179)
        alloc183: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d15(alloc182, metadata["relax.expr.Constant"][185], alloc183)
        alloc184: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv158: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc184, alloc185, alloc186
        R.vm.kill_object(alloc185)
        R.vm.kill_object(alloc186)
        alloc187: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc184, alloc187)
        R.vm.kill_object(alloc184)
        alloc188: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d16(alloc187, metadata["relax.expr.Constant"][190], alloc188)
        R.vm.kill_object(alloc187)
        alloc189: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv162: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc189, alloc190, alloc191
        R.vm.kill_object(alloc190)
        R.vm.kill_object(alloc191)
        alloc192: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc189, alloc192)
        R.vm.kill_object(alloc189)
        alloc193: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.conv2d13(alloc192, metadata["relax.expr.Constant"][195], alloc193)
        R.vm.kill_object(alloc192)
        alloc194: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        ...
        lv166: R.Tuple(R.Tensor((1, 1024, 64, 64), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")) = alloc194, alloc195, alloc196
        R.vm.kill_object(alloc195)
        R.vm.kill_object(alloc196)
        alloc197: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.fused_add2_relu8(alloc194, alloc182, alloc197)
        R.vm.kill_object(alloc182)
        R.vm.kill_object(alloc194)
        alloc198: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d15(alloc197, metadata["relax.expr.Constant"][200], alloc198)
        alloc199: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv171: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc199, alloc200, alloc201
        R.vm.kill_object(alloc200)
        R.vm.kill_object(alloc201)
        alloc202: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc199, alloc202)
        R.vm.kill_object(alloc199)
        alloc203: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.conv2d16(alloc202, metadata["relax.expr.Constant"][205], alloc203)
        R.vm.kill_object(alloc202)
        alloc204: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        ...
        lv175: R.Tuple(R.Tensor((1, 256, 64, 64), dtype="float32"), R.Tensor((256,), dtype="float32"), R.Tensor((256,), dtype="float32")) = alloc204, alloc205, alloc206
        R.vm.kill_object(alloc205)
        R.vm.kill_object(alloc206)
        alloc207: R.Tensor((1, 256, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 256, 64, 64]), R.dtype("float32"))
        cls.fused_relu7(alloc204, alloc207)
        R.vm.kill_object(alloc204)
        alloc208: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.conv2d13(alloc207, metadata["relax.expr.Constant"][210], alloc208)
        R.vm.kill_object(alloc207)
        alloc209: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        ...
        lv179: R.Tuple(R.Tensor((1, 1024, 64, 64), dtype="float32"), R.Tensor((1024,), dtype="float32"), R.Tensor((1024,), dtype="float32")) = alloc209, alloc210, alloc211
        R.vm.kill_object(alloc210)
        R.vm.kill_object(alloc211)
        alloc212: R.Tensor((1, 1024, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 1024, 64, 64]), R.dtype("float32"))
        cls.fused_add2_relu8(alloc209, alloc197, alloc212)
        R.vm.kill_object(alloc197)
        R.vm.kill_object(alloc209)
        alloc213: R.Tensor((1, 512, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 64, 64]), R.dtype("float32"))
        cls.conv2d17(alloc212, metadata["relax.expr.Constant"][215], alloc213)
        alloc214: R.Tensor((1, 512, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 512, 64, 64]), R.dtype("float32"))
        ...
        lv184: R.Tuple(R.Tensor((1, 512, 64, 64), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc214, alloc215, alloc216
        R.vm.kill_object(alloc215)
        R.vm.kill_object(alloc216)
        alloc217: R.Tensor((1, 512, 64, 64), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 512, 64, 64]), R.dtype("float32"))
        ...
        alloc218: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        ...
        alloc219: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        ...
        lv188: R.Tuple(R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc219, alloc220, alloc221
        R.vm.kill_object(alloc220)
        R.vm.kill_object(alloc221)
        alloc222: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.fused_relu10(alloc219, alloc222)
        R.vm.kill_object(alloc219)
        alloc223: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        cls.conv2d19(alloc222, metadata["relax.expr.Constant"][225], alloc223)
        R.vm.kill_object(alloc222)
        alloc224: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        ...
        lv192: R.Tuple(R.Tensor((1, 2048, 32, 32), dtype="float32"), R.Tensor((2048,), dtype="float32"), R.Tensor((2048,), dtype="float32")) = alloc224, alloc225, alloc226
        R.vm.kill_object(alloc225)
        R.vm.kill_object(alloc226)
        alloc227: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        cls.conv2d20(alloc212, metadata["relax.expr.Constant"][230], alloc227)
        R.vm.kill_object(alloc212)
        alloc228: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        ...
        lv195: R.Tuple(R.Tensor((1, 2048, 32, 32), dtype="float32"), R.Tensor((2048,), dtype="float32"), R.Tensor((2048,), dtype="float32")) = alloc228, alloc229, alloc230
        R.vm.kill_object(alloc229)
        R.vm.kill_object(alloc230)
        alloc231: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        cls.fused_add3_relu11(alloc224, alloc228, alloc231)
        R.vm.kill_object(alloc224)
        R.vm.kill_object(alloc228)
        alloc232: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.conv2d21(alloc231, metadata["relax.expr.Constant"][235], alloc232)
        alloc233: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        ...
        lv200: R.Tuple(R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc233, alloc234, alloc235
        R.vm.kill_object(alloc234)
        R.vm.kill_object(alloc235)
        alloc236: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.fused_relu10(alloc233, alloc236)
        R.vm.kill_object(alloc233)
        alloc237: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.conv2d22(alloc236, metadata["relax.expr.Constant"][240], alloc237)
        R.vm.kill_object(alloc236)
        alloc238: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        ...
        lv204: R.Tuple(R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc238, alloc239, alloc240
        R.vm.kill_object(alloc239)
        R.vm.kill_object(alloc240)
        alloc241: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.fused_relu10(alloc238, alloc241)
        R.vm.kill_object(alloc238)
        alloc242: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        cls.conv2d19(alloc241, metadata["relax.expr.Constant"][245], alloc242)
        R.vm.kill_object(alloc241)
        alloc243: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        ...
        lv208: R.Tuple(R.Tensor((1, 2048, 32, 32), dtype="float32"), R.Tensor((2048,), dtype="float32"), R.Tensor((2048,), dtype="float32")) = alloc243, alloc244, alloc245
        R.vm.kill_object(alloc244)
        R.vm.kill_object(alloc245)
        alloc246: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage4, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        ...
        alloc247: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.conv2d21(alloc246, metadata["relax.expr.Constant"][250], alloc247)
        alloc248: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        ...
        lv213: R.Tuple(R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc248, alloc249, alloc250
        R.vm.kill_object(alloc249)
        R.vm.kill_object(alloc250)
        alloc251: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.fused_relu10(alloc248, alloc251)
        R.vm.kill_object(alloc248)
        alloc252: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        cls.conv2d22(alloc251, metadata["relax.expr.Constant"][255], alloc252)
        R.vm.kill_object(alloc251)
        alloc253: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage6, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        ...
        lv217: R.Tuple(R.Tensor((1, 512, 32, 32), dtype="float32"), R.Tensor((512,), dtype="float32"), R.Tensor((512,), dtype="float32")) = alloc253, alloc254, alloc255
        R.vm.kill_object(alloc254)
        R.vm.kill_object(alloc255)
        alloc256: R.Tensor((1, 512, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage5, R.prim_value(0), R.shape([1, 512, 32, 32]), R.dtype("float32"))
        R.vm.kill_object(storage5)
        cls.fused_relu10(alloc253, alloc256)
        R.vm.kill_object(alloc253)
        alloc257: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        cls.conv2d19(alloc256, metadata["relax.expr.Constant"][260], alloc257)
        R.vm.kill_object(alloc256)
        alloc258: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage1, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
        ...
        lv221: R.Tuple(R.Tensor((1, 2048, 32, 32), dtype="float32"), R.Tensor((2048,), dtype="float32"), R.Tensor((2048,), dtype="float32")) = alloc258, alloc259, alloc260
        R.vm.kill_object(alloc259)
        R.vm.kill_object(alloc260)
        alloc261: R.Tensor((1, 2048, 32, 32), dtype="float32") = R.vm.alloc_tensor(storage, R.prim_value(0), R.shape([1, 2048, 32, 32]), R.dtype("float32"))
